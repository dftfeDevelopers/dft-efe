...
namespace alglib
{
  ...
  *************************************************************************/
  ...
  {
    p_struct = (alglib_impl::odesolverstate *)
      alglib_impl::ae_malloc(sizeof(alglib_impl::odesolverstate), NULL);
    if (p_struct == NULL)
  ...
  _odesolverstate_owner::_odesolverstate_owner(const _odesolverstate_owner &rhs)
  {
    ...
    if (p_struct == NULL)
      throw ap_error("ALGLIB: malloc error");
    if (!alglib_impl::_odesolverstate_init_copy(
          p_struct,
  ...
  *************************************************************************/
  ...
  {
    p_struct = (alglib_impl::odesolverreport *)
      alglib_impl::ae_malloc(sizeof(alglib_impl::odesolverreport), NULL);
    if (p_struct == NULL)
      throw ap_error("ALGLIB: malloc error");
    ...
    const _odesolverreport_owner &rhs)
  {
    ...
    if (p_struct == NULL)
      throw ap_error("ALGLIB: malloc error");
    if (!alglib_impl::_odesolverreport_init_copy(
          p_struct,
  ...
  *************************************************************************/
  void
  odesolverrkck(const real_1d_array &y,
                const ae_int_t       n,
  ...
  *************************************************************************/
  bool
  odesolveriteration(const odesolverstate &state)
  {
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
  ...
  void
  odesolversolve(odesolverstate &state,
                 void (*diff)(const real_1d_array &y,
                              double               x,
                              real_1d_array &      dy,
                              void *               ptr),
                 void *ptr)
  {
    ...
    try
      {
        while (
          alglib_impl::odesolveriteration(state.c_ptr(), &_alglib_env_state))
          {
            if (state.needdy)
              {
  ...
  *************************************************************************/
  void
  odesolverresults(const odesolverstate &state,
                   ae_int_t &            m,
                   real_1d_array &       xtbl,
                   real_2d_array &       ytbl,
                   odesolverreport &     rep)
...
namespace alglib_impl
{
  ...
  static void
  odesolver_odesolverinit(ae_int_t                 solvertype,
                          /* Real    */ ae_vector *y,
                          ae_int_t                 n,
                          /* Real    */ ae_vector *x,
                          ae_int_t                 m,
  ...
  *************************************************************************/
  void
  odesolverrkck(/* Real    */ ae_vector *y,
                ae_int_t                 n,
                /* Real    */ ae_vector *x,
                ae_int_t                 m,
                double                   eps,
                ...
                ae_state *               _state)
  {
    ...
    ae_assert(isfinitevector(x, m, _state),
              "ODESolverRKCK: Y contains infinite or NaN values!",
              _state);
    ae_assert(ae_isfinite(eps, _state),
              "ODESolverRKCK: Eps is not finite!",
              _state);
    ae_assert(ae_fp_neq(eps, 0), "ODESolverRKCK: Eps is zero!", _state);
    ae_assert(ae_isfinite(h, _state),
              "ODESolverRKCK: H is not finite!",
              _state);
  ...
  *************************************************************************/
  ae_bool
  odesolveriteration(odesolverstate *state, ae_state *_state)
  {
    ae_int_t n;
    ae_int_t m;
    ae_int_t i;
    ...
    ae_v_move(&state->ytbl.ptr.pp_double[0][0],
              1,
              &state->yc.ptr.p_double[0],
              1,
              ae_v_len(0, n - 1));
    for (j = 0; j <= n - 1; j++)
      {
  ...
  lbl_6:
    ...
    for (j = 0; j <= n - 1; j++)
      {
        state->escale.ptr.p_double[j] =
          ae_maxreal(state->escale.ptr.p_double[j],
                     ae_fabs(state->yc.ptr.p_double[j], _state),
                     _state);
      }
     ...
     */
    ae_v_move(&state->yn.ptr.p_double[0],
              1,
              &state->yc.ptr.p_double[0],
              1,
              ae_v_len(0, n - 1));
    ae_v_move(&state->yns.ptr.p_double[0],
              1,
              &state->yc.ptr.p_double[0],
              1,
              ae_v_len(0, n - 1));
  ...
  lbl_8:
    ...
    ae_v_move(&state->y.ptr.p_double[0],
              1,
              &state->yc.ptr.p_double[0],
              1,
              ae_v_len(0, n - 1));
    for (j = 0; j <= k - 1; j++)
      {
        ...
        ae_v_addd(&state->y.ptr.p_double[0],
                  1,
                  &state->rkk.ptr.pp_double[j][0],
                  1,
                  ae_v_len(0, n - 1),
                  v);
      }
  ...
  lbl_0:
    ...
    v              = h * state->xscale;
    ae_v_moved(&state->rkk.ptr.pp_double[k][0],
               1,
               &state->dy.ptr.p_double[0],
               1,
               ae_v_len(0, n - 1),
               v);
    ...
    ae_v_addd(&state->yn.ptr.p_double[0],
              1,
              &state->rkk.ptr.pp_double[k][0],
              1,
              ae_v_len(0, n - 1),
              v);
    v = state->rkcs.ptr.p_double[k];
    ae_v_addd(&state->yns.ptr.p_double[0],
              1,
              &state->rkk.ptr.pp_double[k][0],
              1,
              ae_v_len(0, n - 1),
  ...
  lbl_10:
        ...
        if (!state->fraceps)
          {
             ...
             */
            err = ae_maxreal(err,
                             ae_fabs(state->yn.ptr.p_double[j] -
                                       state->yns.ptr.p_double[j],
                                     _state),
                             _state);
          }
        else
     ...
     */
    xc = xc + h;
    ae_v_move(&state->yc.ptr.p_double[0],
              1,
              &state->yn.ptr.p_double[0],
              1,
              ae_v_len(0, n - 1));
  ...
  lbl_7:
     ...
     * save result
     */
    ae_v_move(&state->ytbl.ptr.pp_double[i][0],
              1,
              &state->yc.ptr.p_double[0],
              1,
              ae_v_len(0, n - 1));
  ...
  *************************************************************************/
  void
  odesolverresults(odesolverstate *         state,
                   ae_int_t *               m,
                   /* Real    */ ae_vector *xtbl,
                   /* Real    */ ae_matrix *ytbl,
                   odesolverreport *        rep,
    ...
    if (rep->terminationtype > 0)
      {
        *m        = state->m;
        ...
        v = state->xscale;
        ae_v_moved(&xtbl->ptr.p_double[0],
                   1,
                   &state->xg.ptr.p_double[0],
                   1,
        ...
        for (i = 0; i <= state->m - 1; i++)
          {
            ae_v_move(&ytbl->ptr.pp_double[i][0],
                      1,
                      &state->ytbl.ptr.pp_double[i][0],
                      1,
  ...
  *************************************************************************/
    ...
    if (m == 1)
      {
        ...
        ae_v_move(&state->xg.ptr.p_double[0],
                  1,
                  &x->ptr.p_double[0],
                  1,
                  ae_v_len(0, m - 1));
    ...
    if (ae_fp_eq(h, 0))
      {
        ...
        for (i = 2; i <= m - 1; i++)
          {
            v = ae_minreal(v,
                           ae_fabs(x->ptr.p_double[i] - x->ptr.p_double[i - 1],
                                   _state),
                           _state);
          }
        h = 0.001 * v;
  ...
  ae_bool
  _odesolverstate_init(void *_p, ae_state *_state, ae_bool make_automatic)
  {
  ...
  ae_bool
  _odesolverstate_init_copy(void *    _dst,
                            void *    _src,
                            ae_state *_state,
                            ae_bool   make_automatic)
  {
    ...
    if (!ae_vector_init_copy(
          &dst->escale, &src->escale, _state, make_automatic))
      return ae_false;
  ...
  ae_bool
  _odesolverreport_init(void *_p, ae_state *_state, ae_bool make_automatic)
  {
  ...
  ae_bool
  _odesolverreport_init_copy(void *    _dst,
                             void *    _src,
                             ae_state *_state,
                             ae_bool   make_automatic)
  {
