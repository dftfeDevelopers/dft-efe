...
namespace alglib
{
  ...
  *************************************************************************/
  void
  gqgeneraterec(const real_1d_array &alpha,
  ...
  *************************************************************************/
  void
  gqgenerategausslobattorec(const real_1d_array &alpha,
                            const real_1d_array &beta,
                            const double         mu0,
                            const double         a,
                            const double         b,
  ...
  *************************************************************************/
  void
  gqgenerategaussradaurec(const real_1d_array &alpha,
                          const real_1d_array &beta,
                          const double         mu0,
                          const double         a,
                          const ae_int_t       n,
  ...
  *************************************************************************/
  void
  gqgenerategausslegendre(const ae_int_t n,
                          ae_int_t &     info,
                          real_1d_array &x,
                          real_1d_array &w)
  {
  ...
  *************************************************************************/
  void
  gqgenerategaussjacobi(const ae_int_t n,
                        const double   alpha,
                        const double   beta,
                        ae_int_t &     info,
                        real_1d_array &x,
  ...
  *************************************************************************/
  void
  gqgenerategausslaguerre(const ae_int_t n,
                          const double   alpha,
                          ae_int_t &     info,
                          real_1d_array &x,
                          real_1d_array &w)
  ...
  *************************************************************************/
  void
  gqgenerategausshermite(const ae_int_t n,
                         ae_int_t &     info,
                         real_1d_array &x,
                         real_1d_array &w)
  {
  ...
  *************************************************************************/
  void
  gkqgeneraterec(const real_1d_array &alpha,
                 const real_1d_array &beta,
                 const double         mu0,
                 const ae_int_t       n,
                 ae_int_t &           info,
  ...
  *************************************************************************/
  void
  gkqgenerategausslegendre(const ae_int_t n,
                           ae_int_t &     info,
                           real_1d_array &x,
                           real_1d_array &wkronrod,
                           real_1d_array &wgauss)
  ...
  *************************************************************************/
  void
  gkqgenerategaussjacobi(const ae_int_t n,
                         const double   alpha,
                         const double   beta,
                         ae_int_t &     info,
                         real_1d_array &x,
  ...
  *************************************************************************/
  void
  gkqlegendrecalc(const ae_int_t n,
                  ae_int_t &     info,
                  real_1d_array &x,
                  real_1d_array &wkronrod,
                  real_1d_array &wgauss)
  ...
  *************************************************************************/
  void
  gkqlegendretbl(const ae_int_t n,
                 real_1d_array &x,
                 real_1d_array &wkronrod,
                 real_1d_array &wgauss,
                 double &       eps)
  ...
  *************************************************************************/
  ...
  {
    p_struct = (alglib_impl::autogkreport *)
      alglib_impl::ae_malloc(sizeof(alglib_impl::autogkreport), NULL);
    if (p_struct == NULL)
  ...
  _autogkreport_owner::_autogkreport_owner(const _autogkreport_owner &rhs)
  {
    ...
    if (p_struct == NULL)
      throw ap_error("ALGLIB: malloc error");
    if (!alglib_impl::_autogkreport_init_copy(
          p_struct,
  ...
  *************************************************************************/
  ...
  {
    p_struct = (alglib_impl::autogkstate *)
      alglib_impl::ae_malloc(sizeof(alglib_impl::autogkstate), NULL);
    if (p_struct == NULL)
      throw ap_error("ALGLIB: malloc error");
  ...
  _autogkstate_owner::_autogkstate_owner(const _autogkstate_owner &rhs)
  {
    ...
    if (p_struct == NULL)
      throw ap_error("ALGLIB: malloc error");
    if (!alglib_impl::_autogkstate_init_copy(
          p_struct,
  ...
  *************************************************************************/
  void
  autogksmooth(const double a, const double b, autogkstate &state)
  {
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
      {
        alglib_impl::autogksmooth(a,
                                  b,
                                  const_cast<alglib_impl::autogkstate *>(
                                    state.c_ptr()),
                                  &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
        return;
  ...
  *************************************************************************/
  bool
  autogkiteration(const autogkstate &state)
  {
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
      {
        ae_bool result =
          alglib_impl::autogkiteration(const_cast<alglib_impl::autogkstate *>(
                                         state.c_ptr()),
                                       &_alglib_env_state);
        alglib_impl::ae_state_clear(&_alglib_env_state);
  ...
  void
  autogkintegrate(autogkstate &state,
                  void (*func)(double  x,
                               double  xminusa,
                               double  bminusx,
                               double &y,
  ...
  *************************************************************************/
  void
  autogkresults(const autogkstate &state, double &v, autogkreport &rep)
  {
    alglib_impl::ae_state _alglib_env_state;
    alglib_impl::ae_state_init(&_alglib_env_state);
    try
...
namespace alglib_impl
{
  ...
  static void
  autogk_autogkinternalprepare(double               a,
                               double               b,
                               double               eps,
                               double               xwidth,
                               ...
                               ae_state *           _state);
  static ae_bool
  autogk_autogkinternaliteration(autogkinternalstate *state, ae_state *_state);
  static void
  autogk_mheappop(/* Real    */ ae_matrix *heap,
                  ae_int_t                 heapsize,
                  ae_int_t                 heapwidth,
                  ae_state *               _state);
  static void
  autogk_mheappush(/* Real    */ ae_matrix *heap,
                   ae_int_t                 heapsize,
                   ae_int_t                 heapwidth,
                   ae_state *               _state);
  static void
  autogk_mheapresize(/* Real    */ ae_matrix *heap,
                     ae_int_t *               heapsize,
  ...
  *************************************************************************/
  void
  gqgeneraterec(/* Real    */ ae_vector *alpha,
                /* Real    */ ae_vector *beta,
                double                   mu0,
                ae_int_t                 n,
                ae_int_t *               info,
  ...
  *************************************************************************/
  void
  gqgenerategausslobattorec(/* Real    */ ae_vector *alpha,
                            /* Real    */ ae_vector *beta,
                            double                   mu0,
                            double                   a,
                            double                   b,
  ...
  *************************************************************************/
  void
  gqgenerategaussradaurec(/* Real    */ ae_vector *alpha,
                          /* Real    */ ae_vector *beta,
                          double                   mu0,
                          double                   a,
                          ae_int_t                 n,
    ...
    if (*info > 0)
      {
        if (ae_fp_less(x->ptr.p_double[0], -1) ||
            ae_fp_greater(x->ptr.p_double[n - 1], 1))
          {
            *info = -4;
          }
        for (i = 0; i <= n - 2; i++)
  ...
  *************************************************************************/
  void
  gqgenerategaussjacobi(ae_int_t                 n,
                        double                   alpha,
                        double                   beta,
                        ae_int_t *               info,
                        /* Real    */ ae_vector *x,
                        ...
                        ae_state *               _state)
  {
    ...
    *info = 0;
    ...
    t = (apb + 1) * ae_log(2, _state) + lngamma(alpha + 1, &s, _state) +
  ...
  *************************************************************************/
  void
  gqgenerategausslaguerre(ae_int_t                 n,
                          double                   alpha,
                          ae_int_t *               info,
                          /* Real    */ ae_vector *x,
                          /* Real    */ ae_vector *w,
  ...
  *************************************************************************/
  void
  gqgenerategausshermite(ae_int_t                 n,
                         ae_int_t *               info,
                         /* Real    */ ae_vector *x,
                         /* Real    */ ae_vector *w,
                         ae_state *               _state)
  ...
  *************************************************************************/
  void
  gkqgeneraterec(/* Real    */ ae_vector *alpha,
                 /* Real    */ ae_vector *beta,
                 double                   mu0,
                 ae_int_t                 n,
                 ae_int_t *               info,
                 ...
                 ae_state *               _state)
  {
    ...
    *info = 1;
     ...
     */
    ae_vector_set_length(&ta,
                         ae_ifloor((double)(3 * n) / (double)2, _state) + 1,
                         _state);
    ...
    ae_vector_set_length(&ta,
                         ae_iceil((double)(3 * n) / (double)2, _state) + 1,
                         _state);
    ae_v_move(&ta.ptr.p_double[0],
              1,
              &beta->ptr.p_double[0],
    ...
    for (m = 0; m <= n - 2; m++)
      {
        ...
        ae_v_move(
          &ta.ptr.p_double[0], 1, &t.ptr.p_double[0], 1, ae_v_len(0, wlen - 1));
        ae_v_move(
          &t.ptr.p_double[0], 1, &s.ptr.p_double[0], 1, ae_v_len(0, wlen - 1));
        ae_v_move(
          &s.ptr.p_double[0], 1, &ta.ptr.p_double[0], 1, ae_v_len(0, wlen - 1));
      }
    for (j = n / 2; j >= 0; j--)
      {
  ...
  *************************************************************************/
  void
  gkqgenerategaussjacobi(ae_int_t                 n,
                         double                   alpha,
                         double                   beta,
                         ae_int_t *               info,
                         /* Real    */ ae_vector *x,
                         ...
                         ae_state *               _state)
  {
    ...
    *info = 0;
    ...
    gkqgeneraterec(
      &a, &b, b.ptr.p_double[0], n, info, x, wkronrod, wgauss, _state);
  ...
  *************************************************************************/
  void
  autogksmooth(double a, double b, autogkstate *state, ae_state *_state)
  {
  ...
  *************************************************************************/
                ...
                ae_state *   _state)
  {
    ...
    ae_assert(ae_isfinite(a, _state),
              "AutoGKSmoothW: A is not finite!",
              _state);
    ae_assert(ae_isfinite(b, _state),
              "AutoGKSmoothW: B is not finite!",
              _state);
    ae_assert(ae_isfinite(xwidth, _state),
              "AutoGKSmoothW: XWidth is not finite!",
              _state);
    state->wrappermode = 0;
    state->a           = a;
    state->b           = b;
  ...
  *************************************************************************/
                 ...
                 ae_state *   _state)
  {
    ...
    ae_assert(ae_isfinite(a, _state),
              "AutoGKSingular: A is not finite!",
              _state);
    ae_assert(ae_isfinite(b, _state),
              "AutoGKSingular: B is not finite!",
              _state);
    ae_assert(ae_isfinite(alpha, _state),
              "AutoGKSingular: Alpha is not finite!",
              _state);
    ae_assert(ae_isfinite(beta, _state),
              "AutoGKSingular: Beta is not finite!",
              _state);
    state->wrappermode = 1;
    state->a           = a;
    state->b           = b;
  ...
  *************************************************************************/
  ae_bool
  autogkiteration(autogkstate *state, ae_state *_state)
  {
    double  s;
    double  tmp;
    double  eps;
     ...
     * general case
     */
    autogk_autogkinternalprepare(
      a, b, eps, state->xwidth, &state->internalstate, _state);
  lbl_5:
  ...
  lbl_3:
     ...
     * 0, (0.5*(b-a))^(1+alpha))
     */
    autogk_autogkinternalprepare(0,
  ...
  *************************************************************************/
  void
  autogkresults(autogkstate * state,
                double *      v,
                autogkreport *rep,
                ae_state *    _state)
  {
  ...
  *************************************************************************/
  ...
  autogk_autogkinternaliteration(autogkinternalstate *state, ae_state *_state)
  {
    ...
    gkqgenerategausslegendre(
      state->n, &info, &state->qn, &state->wk, &state->wg, _state);
    if (info < 0)
      {
        state->info = -5;
        state->r    = 0;
    ...
    for (i = 0; i <= state->n - 1; i++)
      {
        ...
        state->wr.ptr.p_double[i] =
          0.5 *
          ae_fabs(state->qn.ptr.p_double[i - 1] - state->qn.ptr.p_double[i + 1],
                  _state);
      }
    ...
    state->heapsize  = 1;
    state->heapused  = 1;
    ae_matrix_set_length(&state->heap,
                         state->heapsize,
                         state->heapwidth,
                         _state);
                     ...
                     ae_state *               _state)
  {
    ...
    for (i = 0; i <= *heapsize - 1; i++)
      {
        ae_v_move(&tmp.ptr.pp_double[i][0],
                  1,
                  &heap->ptr.pp_double[i][0],
                  1,
    ...
    for (i = 0; i <= *heapsize - 1; i++)
      {
        ae_v_move(&heap->ptr.pp_double[i][0],
                  1,
                  &tmp.ptr.pp_double[i][0],
                  1,
                  ae_v_len(0, heapwidth - 1));
      }
  ...
  ae_bool
  _autogkreport_init(void *_p, ae_state *_state, ae_bool make_automatic)
  {
  ...
  ae_bool
  _autogkreport_init_copy(void *    _dst,
                          void *    _src,
                          ae_state *_state,
  ...
  ae_bool
  _autogkinternalstate_init(void *_p, ae_state *_state, ae_bool make_automatic)
  {
  ...
  ae_bool
  _autogkinternalstate_init_copy(void *    _dst,
                                 void *    _src,
                                 ae_state *_state,
                                 ae_bool   make_automatic)
  {
  ...
  ae_bool
  _autogkstate_init(void *_p, ae_state *_state, ae_bool make_automatic)
  {
  ...
  ae_bool
  _autogkstate_init_copy(void *    _dst,
                         void *    _src,
                         ae_state *_state,
                         ae_bool   make_automatic)
  {
    ...
    if (!_autogkinternalstate_init_copy(
