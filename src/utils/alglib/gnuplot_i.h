...
///  POSX pipe support Tested on Windows (MinGW and Visual C++) and Linux (GCC)
///
/// Version history:
/// 0. C interface
...
public:
  ...
  Gnuplot &
  savetops(const std::string &filename);

  Gnuplot &
  savetopng(const std::string &fileName);
  ...
  ///   from file
  Gnuplot &
  plotfile_x(const std::string &filename,
  ...
  ///   from file
  Gnuplot &
  plotfile_xy(const std::string &filename,
  ...
  ///   from file
  Gnuplot &
  plotfile_xy_err(const std::string &filename,
                  const unsigned int column_x  = 1,
                  const unsigned int column_y  = 2,
  ...
  ///   from file
  Gnuplot &
  plotfile_xyz(const std::string &filename,
               const unsigned int column_x = 1,
               const unsigned int column_y = 2,
  ...
  /// plot image
  Gnuplot &
  plot_image(const unsigned char *ucPicBuf,
...
// -----------------------------------------------------------------------------
//
// saves a gnuplot image to a jpeg file
//
Gnuplot &
Gnuplot::savetopng(const std::string &fileName)
{
