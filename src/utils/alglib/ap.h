...
#    ifdef AE_USE_CPP
namespace alglib_impl
{ // namespace declaration continued
#    endif
...
#  endif
  ...
  * when no OS is defined, it uses "fake lock" (just stub which is not
  thread-safe): a) "fake lock" can be in locked or free mode b) "fake lock" can
  be used only from one thread - one which created lock c) when thread acquires
  free lock, it immediately returns d) when thread acquires busy lock, program
  is terminated (because lock is already acquired and no one else can free it)
  *************************************************************************/
  typedef struct
  {
#if AE_OS == AE_WINDOWS
  ...
  *************************************************************************/
  ...
  ae_smart_ptr_init(ae_smart_ptr *dst,
                    ...
                    ae_bool       make_automatic);
  void
  ae_smart_ptr_clear(void *_dst); /* accepts ae_smart_ptr* */
  void
...
namespace alglib
{
  ...
  ********************************************************************/
  ...
  public:
    ...
    static void
    make_assertion(bool bClause);
    static void
    make_assertion(bool bClause, const char *msg);
  ...
  ********************************************************************/
  ...
  public:
    ...
    std::string
    tostring(int dps) const;

    double x, y;
  };

  const alglib::complex
  operator/(const alglib::complex &lhs, const alglib::complex &rhs);
  const bool
  operator==(const alglib::complex &lhs, const alglib::complex &rhs);
  const bool
  operator!=(const alglib::complex &lhs, const alglib::complex &rhs);
  const alglib::complex
  operator+(const alglib::complex &lhs);
  const alglib::complex
  operator-(const alglib::complex &lhs);
  const alglib::complex
  operator+(const alglib::complex &lhs, const alglib::complex &rhs);
  const alglib::complex
  operator+(const alglib::complex &lhs, const double &rhs);
  const alglib::complex
  operator+(const double &lhs, const alglib::complex &rhs);
  const alglib::complex
  operator-(const alglib::complex &lhs, const alglib::complex &rhs);
  const alglib::complex
  operator-(const alglib::complex &lhs, const double &rhs);
  ...
  operator/(const alglib::complex &lhs, const double &rhs);
  double
  abscomplex(const alglib::complex &z);
  alglib::complex
  conj(const alglib::complex &z);
  alglib::complex
  csqr(const alglib::complex &z);
  ...
  ********************************************************************/
  double
  vdotproduct(const double *v0,
              ae_int_t      stride0,
              const double *v1,
              ae_int_t      stride1,
              ae_int_t      n);
  double
  vdotproduct(const double *v1, const double *v2, ae_int_t N);

  alglib::complex
  vdotproduct(const alglib::complex *v0,
              ae_int_t               stride0,
              const char *           conj0,
              ...
              ae_int_t               n);
  alglib::complex
  vdotproduct(const alglib::complex *v1, const alglib::complex *v2, ae_int_t N);
  ...
  vmove(double *      vdst,
        ...
        ae_int_t      n);
  void
  vmove(double *vdst, const double *vsrc, ae_int_t N);
  ...
  vmove(alglib::complex *      vdst,
        ...
        ae_int_t               n);
  void
  vmove(alglib::complex *vdst, const alglib::complex *vsrc, ae_int_t N);

  void
  vmoveneg(double *      vdst,
           ae_int_t      stride_dst,
           const double *vsrc,
           ae_int_t      stride_src,
           ae_int_t      n);
  void
  vmoveneg(double *vdst, const double *vsrc, ae_int_t N);

  void
  vmoveneg(alglib::complex *      vdst,
           ae_int_t               stride_dst,
           const alglib::complex *vsrc,
           ae_int_t               stride_src,
           const char *           conj_src,
           ae_int_t               n);
  void
  vmoveneg(alglib::complex *vdst, const alglib::complex *vsrc, ae_int_t N);
  ...
  vmove(double *      vdst,
        ...
        double        alpha);
  void
  vmove(double *vdst, const double *vsrc, ae_int_t N, double alpha);
  ...
  vadd(double *      vdst,
       ...
       ae_int_t      n);
  void
  vadd(double *vdst, const double *vsrc, ae_int_t N);
  ...
  vadd(alglib::complex *      vdst,
       ...
       ae_int_t               n);
  void
  vadd(alglib::complex *vdst, const alglib::complex *vsrc, ae_int_t N);
  ...
  vadd(double *      vdst,
       ...
       double        alpha);
  void
  vadd(double *vdst, const double *vsrc, ae_int_t N, double alpha);
  ...
  vsub(double *      vdst,
       ...
       ae_int_t      n);
  void
  vsub(double *vdst, const double *vsrc, ae_int_t N);
  ...
  vsub(alglib::complex *      vdst,
       ...
       ae_int_t               n);
  void
  vsub(alglib::complex *vdst, const alglib::complex *vsrc, ae_int_t N);
  ...
  vsub(double *      vdst,
       ...
       double        alpha);
  void
  vsub(double *vdst, const double *vsrc, ae_int_t N, double alpha);
  ...
  void
  vmul(alglib::complex *vdst, ae_int_t stride_dst, ae_int_t n, double alpha);
  void
  vmul(alglib::complex *vdst, ae_int_t N, double alpha);

  void
  vmul(alglib::complex *vdst,
       ae_int_t         stride_dst,
       ae_int_t         n,
       alglib::complex  alpha);
  void
  vmul(alglib::complex *vdst, ae_int_t N, alglib::complex alpha);
  ...
  ********************************************************************/
  ...
  public:
    ...
    operator=(const ae_vector_wrapper &rhs);

    void
    setlength(ae_int_t iLen);
    ae_int_t
    length() const;

    void
    attach_to(alglib_impl::ae_vector *ptr);
    void
    allocate_own(ae_int_t size, alglib_impl::ae_datatype datatype);
  ...
  public:
    ...
    void
    setcontent(ae_int_t iLen, const bool *pContent);
    ae_bool *
    getcontent();
    const ae_bool *
    getcontent() const;
  ...
  public:
    ...
    void
    setcontent(ae_int_t iLen, const ae_int_t *pContent);
  ...
  public:
    ...
    void
    setcontent(ae_int_t iLen, const double *pContent);
    double *
    getcontent();
    const double *
    getcontent() const;
  ...
  public:
    ...
    void
    setcontent(ae_int_t iLen, const alglib::complex *pContent);
    alglib::complex *
    getcontent();
    const alglib::complex *
    getcontent() const;
  ...
  public:
    ...
    const ae_matrix_wrapper &
    operator=(const ae_matrix_wrapper &rhs);

    void
    setlength(ae_int_t rows, ae_int_t cols);
    ae_int_t
    rows() const;
    ae_int_t
    cols() const;
    ...
    void
    attach_to(alglib_impl::ae_matrix *ptr);
    void
    allocate_own(ae_int_t                 rows,
                 ae_int_t                 cols,
  ...
  public:
    ...
    const ae_bool &
    operator()(ae_int_t i, ae_int_t j) const;
    ae_bool &
    ...
    void
    setcontent(ae_int_t irows, ae_int_t icols, const bool *pContent);
  ...
  public:
    ...
    void
    setcontent(ae_int_t irows, ae_int_t icols, const ae_int_t *pContent);
  ...
  public:
    ...
    void
    setcontent(ae_int_t irows, ae_int_t icols, const double *pContent);
  ...
  public:
    ...
    void
    setcontent(ae_int_t irows, ae_int_t icols, const alglib::complex *pContent);
  ...
  ********************************************************************/
  ...
  bool readstrings(std::string file, std::list<std::string> *pOutput,
  std::string comment); void explodestring(std::string s, char sep,
  std::vector<std::string> *pOutput); std::string xtrim(std::string s);*/
