...
{
  static double
  apserv_inttoreal(ae_int_t a, ae_state *_state);


  static void
  tsort_tagsortfastirec(/* Real    */ ae_vector *a,
                        /* Integer */ ae_vector *b,
                        /* Real    */ ae_vector *bufa,
                        ...
                        ae_state *               _state);
  static void
  tsort_tagsortfastrrec(/* Real    */ ae_vector *a,
                        /* Real    */ ae_vector *b,
                        /* Real    */ ae_vector *bufa,
                        /* Real    */ ae_vector *bufb,
                        ae_int_t                 i1,
                        ...
                        ae_state *               _state);
  static void
  tsort_tagsortfastrec(/* Real    */ ae_vector *a,
                       /* Real    */ ae_vector *bufa,
                       ae_int_t                 i1,
                       ae_int_t                 i2,
                       ae_state *               _state);
  ...
  static void
  hsschur_internalauxschur(ae_bool                  wantt,
                           ae_bool                  wantz,
                           ae_int_t                 n,
                           ae_int_t                 ilo,
                           ae_int_t                 ihi,
  ...
  hsschur_aux2x2schur(double *  a,
                      ...
                      ae_state *_state);
  static double
  hsschur_extschursign(double a, double b, ae_state *_state);
  static ae_int_t
  hsschur_extschursigntoone(double b, ae_state *_state);



  static ae_bool
  safesolve_cbasicsolveandupdate(ae_complex  alpha,
                                 ae_complex  beta,
                                 double      lnmax,
                                 double      bnorm,
                                 double      maxgrowth,
  ...
  xblas_xsum(/* Real    */ ae_vector *w,
             ...
             ae_state *               _state);
  static double
  xblas_xfastpow(double r, ae_int_t n, ae_state *_state);
  ...
  static void
  ftbase_ftbasegenerateplanrec(ae_int_t  n,
                               ae_int_t  tasktype,
                               ftplan *  plan,
                               ae_int_t *plansize,
                               ...
                               ae_state *_state);
  static void
  ftbase_ftbaseprecomputeplanrec(ftplan *  plan,
                                 ae_int_t  entryoffset,
                                 ae_int_t  stackptr,
                                 ae_state *_state);
  static void
  ftbase_ffttwcalc(/* Real    */ ae_vector *a,
                   ae_int_t                 aoffset,
                   ae_int_t                 n1,
                   ae_int_t                 n2,
                   ae_state *               _state);
  static void
  ftbase_internalcomplexlintranspose(/* Real    */ ae_vector *a,
                                     ae_int_t                 m,
                                     ae_int_t                 n,
                                     ae_int_t                 astart,
                                     /* Real    */ ae_vector *buf,
                                     ae_state *               _state);
  static void
  ftbase_internalreallintranspose(/* Real    */ ae_vector *a,
                                  ae_int_t                 m,
                                  ae_int_t                 n,
                                  ae_int_t                 astart,
                                  /* Real    */ ae_vector *buf,
                                  ae_state *               _state);
  static void
  ftbase_ffticltrec(/* Real    */ ae_vector *a,
                    ae_int_t                 astart,
                    ae_int_t                 astride,
                    /* Real    */ ae_vector *b,
                    ae_int_t                 bstart,
                    ...
                    ae_state *               _state);
  static void
  ftbase_fftirltrec(/* Real    */ ae_vector *a,
                    ae_int_t                 astart,
                    ae_int_t                 astride,
                    /* Real    */ ae_vector *b,
                    ae_int_t                 bstart,
                    ...
                    ae_state *               _state);
  static void
  ftbase_ftbasefindsmoothrec(ae_int_t  n,
                             ae_int_t  seed,
                             ae_int_t  leastfactor,
                             ae_int_t *best,
                             ae_state *_state);
  static void
  ftbase_fftarrayresize(/* Integer */ ae_vector *a,
                        ae_int_t *               asize,
                        ae_int_t                 newasize,
                        ae_state *               _state);
  static void
  ftbase_reffht(/* Real    */ ae_vector *a,
                ae_int_t                 n,
                ae_int_t                 offs,
                ae_state *               _state);
  ...
  ae_int_t
  getrdfserializationcode(ae_state *_state)
  {
    ae_int_t result;
  ...
  ae_int_t
  getkdtreeserializationcode(ae_state *_state)
  {
    ae_int_t result;
  ...
  ae_int_t
  getmlpserializationcode(ae_state *_state)
  {
    ae_int_t result;
  ...
  ae_int_t
  getmlpeserializationcode(ae_state *_state)
  {
    ae_int_t result;
  ...
  ae_int_t
  getrbfserializationcode(ae_state *_state)
  {
    ae_int_t result;
  ...
  *************************************************************************/
  ae_bool
  approxequalrel(double a, double b, double tol, ae_state *_state)
  {
    ae_bool result;


    result =
      ae_fp_less_eq(ae_fabs(a - b, _state),
                    ae_maxreal(ae_fabs(a, _state), ae_fabs(b, _state), _state) *
                      tol);
    return result;
  }
  ...
  *************************************************************************/
  ae_bool
  aredistinct(/* Real    */ ae_vector *x, ae_int_t n, ae_state *_state)
  {
    double   a;
    double   b;
    ae_int_t i;
    ...
    ae_assert(!nonsorted,
              "APSERVAreDistinct: internal error (not sorted)",
              _state);
    for (i = 1; i <= n - 1; i++)
      {
  ...
  *************************************************************************/
  ae_bool
  aresameboolean(ae_bool v1, ae_bool v2, ae_state *_state)
  {
    ae_bool result;
  ...
  *************************************************************************/
  void
  bvectorsetlengthatleast(/* Boolean */ ae_vector *x,
                          ae_int_t                 n,
                          ae_state *               _state)
  {
    if (x->cnt < n)
  ...
  *************************************************************************/
  void
  ivectorsetlengthatleast(/* Integer */ ae_vector *x,
                          ae_int_t                 n,
                          ae_state *               _state)
  {
    if (x->cnt < n)
  ...
  *************************************************************************/
  void
  rvectorsetlengthatleast(/* Real    */ ae_vector *x,
                          ae_int_t                 n,
                          ae_state *               _state)
  {
    if (x->cnt < n)
  ...
  *************************************************************************/
  void
  rmatrixsetlengthatleast(/* Real    */ ae_matrix *x,
                          ae_int_t                 m,
                          ae_int_t                 n,
                          ae_state *               _state)
  {
  ...
  *************************************************************************/
  void
  rmatrixresize(/* Real    */ ae_matrix *x,
                ae_int_t                 m,
                ae_int_t                 n,
                ae_state *               _state)
  {
  ...
  *************************************************************************/
  ae_bool
  isfinitevector(/* Real    */ ae_vector *x, ae_int_t n, ae_state *_state)
  {
    ae_int_t i;
    ae_bool  result;
  ...
  *************************************************************************/
  ae_bool
  isfinitecvector(/* Complex */ ae_vector *z, ae_int_t n, ae_state *_state)
  {
    ae_int_t i;
    ae_bool  result;
  ...
  *************************************************************************/
  ae_bool
  apservisfinitematrix(/* Real    */ ae_matrix *x,
                       ae_int_t                 m,
                       ae_int_t                 n,
                       ae_state *               _state)
  {
  ...
  *************************************************************************/
  ae_bool
  apservisfinitecmatrix(/* Complex */ ae_matrix *x,
                        ae_int_t                 m,
                        ae_int_t                 n,
                        ae_state *               _state)
  {
  ...
  *************************************************************************/
  ae_bool
  isfinitertrmatrix(/* Real    */ ae_matrix *x,
                    ae_int_t                 n,
                    ae_bool                  isupper,
                    ae_state *               _state)
  {
  ...
  *************************************************************************/
  ae_bool
  apservisfinitectrmatrix(/* Complex */ ae_matrix *x,
                          ae_int_t                 n,
                          ae_bool                  isupper,
                          ae_state *               _state)
  {
  ...
  *************************************************************************/
  ae_bool
  apservisfiniteornanmatrix(/* Real    */ ae_matrix *x,
                            ae_int_t                 m,
                            ae_int_t                 n,
                            ae_state *               _state)
  {
    ...
    ae_assert(n >= 0,
              "APSERVIsFiniteOrNaNMatrix: internal error (N<0)",
              _state);
    ae_assert(m >= 0,
              "APSERVIsFiniteOrNaNMatrix: internal error (M<0)",
              _state);
    for (i = 0; i <= m - 1; i++)
      {
        for (j = 0; j <= n - 1; j++)
  ...
  *************************************************************************/
  double
  safepythag2(double x, double y, ae_state *_state)
  {
    double w;
    double xabs;
    double yabs;
  ...
  *************************************************************************/
  double
  safepythag3(double x, double y, double z, ae_state *_state)
  {
    double w;
    double result;
  ...
  *************************************************************************/
  ae_int_t
  saferdiv(double x, double y, double *r, ae_state *_state)
  {
    ae_int_t result;
  ...
  *************************************************************************/
  double
  safeminposrv(double x, double y, double v, ae_state *_state)
  {
    double r;
    double result;
  ...
  *************************************************************************/
  void
  apperiodicmap(double *x, double a, double b, double *k, ae_state *_state)
  {
    *k = 0;
  ...
  *************************************************************************/
  double
  boundval(double x, double b1, double b2, ae_state *_state)
  {
    double result;
  ...
  *************************************************************************/
  void
  alloccomplex(ae_serializer *s, ae_complex v, ae_state *_state)
  {
  ...
  *************************************************************************/
  void
  serializecomplex(ae_serializer *s, ae_complex v, ae_state *_state)
  {
  ...
  *************************************************************************/
  ae_complex
  unserializecomplex(ae_serializer *s, ae_state *_state)
  {
    ae_complex result;
  ...
  *************************************************************************/
  void
  allocrealarray(ae_serializer *          s,
                 /* Real    */ ae_vector *v,
                 ae_int_t                 n,
                 ae_state *               _state)
  {
  ...
  *************************************************************************/
  void
  serializerealarray(ae_serializer *          s,
                     /* Real    */ ae_vector *v,
                     ae_int_t                 n,
                     ae_state *               _state)
  {
  ...
  *************************************************************************/
  void
  unserializerealarray(ae_serializer *          s,
                       /* Real    */ ae_vector *v,
                       ae_state *               _state)
  {
    ae_int_t n;
  ...
  *************************************************************************/
  void
  allocintegerarray(ae_serializer *          s,
                    /* Integer */ ae_vector *v,
                    ae_int_t                 n,
                    ae_state *               _state)
  {
  ...
  *************************************************************************/
  void
  serializeintegerarray(ae_serializer *          s,
                        /* Integer */ ae_vector *v,
                        ae_int_t                 n,
                        ae_state *               _state)
  {
  ...
  *************************************************************************/
  void
  unserializeintegerarray(ae_serializer *          s,
                          /* Integer */ ae_vector *v,
                          ae_state *               _state)
  {
    ae_int_t n;
  ...
  *************************************************************************/
  void
  allocrealmatrix(ae_serializer *          s,
                  /* Real    */ ae_matrix *v,
                  ae_int_t                 n0,
                  ae_int_t                 n1,
                  ae_state *               _state)
  ...
  *************************************************************************/
  void
  serializerealmatrix(ae_serializer *          s,
                      /* Real    */ ae_matrix *v,
                      ae_int_t                 n0,
                      ae_int_t                 n1,
                      ae_state *               _state)
  ...
  *************************************************************************/
  void
  unserializerealmatrix(ae_serializer *          s,
                        /* Real    */ ae_matrix *v,
                        ae_state *               _state)
  {
    ae_int_t i;
  ...
  *************************************************************************/
  void
  copyintegerarray(/* Integer */ ae_vector *src,
  ...
  *************************************************************************/
  void
  copyrealarray(/* Real    */ ae_vector *src,
                /* Real    */ ae_vector *dst,
                ae_state *               _state)
  {
    ae_int_t i;
  ...
  *************************************************************************/
  void
  copyrealmatrix(/* Real    */ ae_matrix *src,
                 /* Real    */ ae_matrix *dst,
                 ae_state *               _state)
  {
    ae_int_t i;
  ...
  *************************************************************************/
  ...
  ae_bool
  _apbuffers_init(void *_p, ae_state *_state, ae_bool make_automatic)
  {
  ...
  ae_bool
  _apbuffers_init_copy(void *    _dst,
                       void *    _src,
                       ae_state *_state,
  ...
  ae_bool
  _sboolean_init(void *_p, ae_state *_state, ae_bool make_automatic)
  {
  ...
  ae_bool
  _sbooleanarray_init(void *_p, ae_state *_state, ae_bool make_automatic)
  {
  ...
  ae_bool
  _sbooleanarray_init_copy(void *    _dst,
                           void *    _src,
                           ae_state *_state,
                           ae_bool   make_automatic)
  {
  ...
  ae_bool
  _sinteger_init(void *_p, ae_state *_state, ae_bool make_automatic)
  {
  ...
  ae_bool
  _sintegerarray_init(void *_p, ae_state *_state, ae_bool make_automatic)
  {
  ...
  ae_bool
  _sintegerarray_init_copy(void *    _dst,
                           void *    _src,
                           ae_state *_state,
                           ae_bool   make_automatic)
  {
  ...
  ae_bool
  _sreal_init(void *_p, ae_state *_state, ae_bool make_automatic)
  {
    sreal *p = (sreal *)_p;
    ae_touch_ptr((void *)p);
    return ae_true;
  ...
  ae_bool
  _srealarray_init(void *_p, ae_state *_state, ae_bool make_automatic)
  {
  ...
  ae_bool
  _srealarray_init_copy(void *    _dst,
                        void *    _src,
                        ae_state *_state,
                        ae_bool   make_automatic)
  {
  ...
  ae_bool
  _scomplex_init(void *_p, ae_state *_state, ae_bool make_automatic)
  {
  ...
  ae_bool
  _scomplexarray_init(void *_p, ae_state *_state, ae_bool make_automatic)
  {
  ...
  ae_bool
  _scomplexarray_init_copy(void *    _dst,
                           void *    _src,
                           ae_state *_state,
                           ae_bool   make_automatic)
  {
  ...
  *************************************************************************/
  void
  tagsortmiddleir(/* Integer */ ae_vector *a,
                  /* Real    */ ae_vector *b,
                  ae_int_t                 offset,
                  ae_int_t                 n,
                  ae_state *               _state)
        ...
        while (t != 1)
          {
            ...
            if (a->ptr.p_int[offset + k - 1] >= a->ptr.p_int[offset + t - 1])
            ...
            else
              {
                ...
                b->ptr.p_double[offset + k - 1] =
                  b->ptr.p_double[offset + t - 1];
        ...
        while (t != 0)
          {
            ...
            if (k > i)
            ...
            else
              {
                ...
                if (a->ptr.p_int[offset + t - 1] >=
                    a->ptr.p_int[offset + k - 1])
                  {
                    t = 0;
                  }
                else
  ...
  *************************************************************************/
  void
  tagheapreplacetopi(/* Real    */ ae_vector *a,
                     /* Integer */ ae_vector *b,
                     ae_int_t                 n,
                     double                   va,
                     ae_int_t                 vb,
  ...
  *************************************************************************/
  ae_int_t
  lowerbound(/* Real    */ ae_vector *a, ae_int_t n, double t, ae_state *_state)
  {
    ae_int_t l;
    ae_int_t half;
    ae_int_t first;
  ...
  *************************************************************************/
  ae_int_t
  upperbound(/* Real    */ ae_vector *a, ae_int_t n, double t, ae_state *_state)
  {
    ae_int_t l;
    ae_int_t half;
    ae_int_t first;
        ...
        do
          {
            ...
            while (t != 1)
              {
                k = t / 2;
                if (ae_fp_greater_eq(buf->ra1.ptr.p_double[k - 1],
                                     buf->ra1.ptr.p_double[t - 1]))
                  {
                    t = 1;
                  }
                else
            ...
            while (t != 0)
              {
                ...
                if (k > i)
                ...
                else
                  {
                    if (k < i)
                      {
                        if (ae_fp_greater(buf->ra1.ptr.p_double[k],
                                          buf->ra1.ptr.p_double[k - 1]))
                          {
                            k = k + 1;
                          }
                      }
                    if (ae_fp_greater_eq(buf->ra1.ptr.p_double[t - 1],
                                         buf->ra1.ptr.p_double[k - 1]))
                      {
                        t = 0;
                      }
  ...
  *************************************************************************/
                    ...
                    ae_state *               _state)
  {
    ...
    return result;
#else
    return _ialglib_i_cmatrixrighttrsmf(
      m, n, a, i1, j1, isupper, isunit, optype, x, i2, j2);
#endif
  }
  ...
  *************************************************************************/
                   ...
                   ae_state *               _state)
  {
    ...
    return result;
#else
    return _ialglib_i_cmatrixlefttrsmf(
      m, n, a, i1, j1, isupper, isunit, optype, x, i2, j2);
#endif
  }
  ...
  *************************************************************************/
                    ...
                    ae_state *               _state)
  {
    ...
    return result;
#else
    return _ialglib_i_rmatrixrighttrsmf(
      m, n, a, i1, j1, isupper, isunit, optype, x, i2, j2);
#endif
  }
  ...
  *************************************************************************/
                   ...
                   ae_state *               _state)
  {
    ...
    return result;
#else
    return _ialglib_i_rmatrixlefttrsmf(
      m, n, a, i1, j1, isupper, isunit, optype, x, i2, j2);
#endif
  }
  ...
  *************************************************************************/
               ...
               ae_state *               _state)
  {
    ...
    return result;
#else
    return _ialglib_i_cmatrixsyrkf(
      n, k, alpha, a, ia, ja, optypea, beta, c, ic, jc, isupper);
#endif
  }
  ...
  *************************************************************************/
               ...
               ae_state *               _state)
  {
    ...
    return result;
#else
    return _ialglib_i_rmatrixsyrkf(
      n, k, alpha, a, ia, ja, optypea, beta, c, ic, jc, isupper);
#endif
  }
  ...
  *************************************************************************/
               ...
               ae_state *               _state)
  {
    ...
    return result;
#else
    return _ialglib_i_rmatrixgemmf(
      m, n, k, alpha, a, ia, ja, optypea, b, ib, jb, optypeb, beta, c, ic, jc);
#endif
  }
  ...
  *************************************************************************/
               ...
               ae_state *               _state)
  {
    ...
    return result;
#else
    return _ialglib_i_cmatrixgemmf(
      m, n, k, alpha, a, ia, ja, optypea, b, ib, jb, optypeb, beta, c, ic, jc);
#endif
  }
  ...
  ae_int_t
  vectoridxabsmax(/* Real    */ ae_vector *x,
                  ae_int_t                 i1,
                  ae_int_t                 i2,
                  ae_state *               _state)
  {
  ...
  ae_int_t
  columnidxabsmax(/* Real    */ ae_matrix *x,
                  ae_int_t                 i1,
                  ae_int_t                 i2,
                  ae_int_t                 j,
                  ae_state *               _state)
  ...
  double
  upperhessenberg1norm(/* Real    */ ae_matrix *a,
                       ae_int_t                 i1,
                       ae_int_t                 i2,
                       ae_int_t                 j1,
                       ae_int_t                 j2,
             ...
             ae_state *               _state)
  {
    ...
    for (isrc = is1; isrc <= is2; isrc++)
      {
        idst = isrc - is1 + id1;
        ae_v_move(&b->ptr.pp_double[idst][jd1],
                  1,
                  &a->ptr.pp_double[isrc][js1],
                  1,
                  ae_v_len(jd1, jd2));
      }
  }
  ...
  void
  inplacetranspose(/* Real    */ ae_matrix *a,
                   ae_int_t                 i1,
                   ae_int_t                 i2,
                   ae_int_t                 j1,
                   ae_int_t                 j2,
    ...
    for (i = i1; i <= i2 - 1; i++)
      {
        ...
        jps = j1 + ips - i1;
        l   = i2 - i;
        ae_v_move(&work->ptr.p_double[1],
                  1,
                  &a->ptr.pp_double[ips][j],
                  a->stride,
                  ae_v_len(1, l));
        ae_v_move(&a->ptr.pp_double[ips][j],
                  a->stride,
                  &a->ptr.pp_double[i][jps],
                  1,
                  ae_v_len(ips, i2));
        ae_v_move(&a->ptr.pp_double[i][jps],
                  1,
                  &work->ptr.p_double[1],
                  1,
                  ae_v_len(jps, j2));
  ...
  void
  copyandtranspose(/* Real    */ ae_matrix *a,
                   ae_int_t                 is1,
                   ae_int_t                 is2,
                   ae_int_t                 js1,
                   ae_int_t                 js2,
                   ...
                   ae_state *               _state)
  {
    ...
    ae_assert(is2 - is1 == jd2 - jd1,
              "CopyAndTranspose: different sizes!",
              _state);
    ae_assert(js2 - js1 == id2 - id1,
              "CopyAndTranspose: different sizes!",
              _state);
    for (isrc = is1; isrc <= is2; isrc++)
      {
        jdst = isrc - is1 + jd1;
        ae_v_move(&b->ptr.pp_double[id1][jdst],
                  b->stride,
                  &a->ptr.pp_double[isrc][js1],
                  1,
                  ae_v_len(id1, id2));
  ...
  void
  matrixvectormultiply(/* Real    */ ae_matrix *a,
                       ae_int_t                 i1,
                       ae_int_t                 i2,
                       ae_int_t                 j1,
                       ae_int_t                 j2,
    ...
    if (!trans)
      {
        ...
        for (i = i1; i <= i2; i++)
          {
            v = ae_v_dotproduct(&a->ptr.pp_double[i][j1],
                                1,
                                &x->ptr.p_double[ix1],
                                1,
                                ae_v_len(j1, j2));
        ...
        for (i = i1; i <= i2; i++)
          {
            ...
            ae_v_addd(&y->ptr.p_double[iy1],
                      1,
                      &a->ptr.pp_double[i][j1],
                      1,
                      ae_v_len(iy1, iy2),
                      v);
          }
  ...
  double
  pythag2(double x, double y, ae_state *_state)
  {
    double w;
    double xabs;
    double yabs;
  ...
  void
  matrixmatrixmultiply(/* Real    */ ae_matrix *a,
                       ae_int_t                 ai1,
                       ae_int_t                 ai2,
                       ae_int_t                 aj1,
                       ae_int_t                 aj2,
            ...
            for (r = bi1; r <= bi2; r++)
              {
                ...
                k = ci1 + l - ai1;
                ae_v_addd(&c->ptr.pp_double[k][cj1],
                          1,
                          &b->ptr.pp_double[r][bj1],
                          1,
                          ae_v_len(cj1, cj2),
                          v);
              }
            ...
            for (r = bi1; r <= bi2; r++)
              {
                for (l = ai1; l <= ai2; l++)
                  {
                    v = ae_v_dotproduct(&a->ptr.pp_double[l][aj1],
                                        1,
                                        &b->ptr.pp_double[r][bj1],
                                        1,
                                        ae_v_len(aj1, aj2));
                ...
                for (l = ai1; l <= ai2; l++)
                  {
                    ...
                    ae_v_addd(&work->ptr.p_double[1],
                              1,
                              &a->ptr.pp_double[l][aj1],
                              1,
                              ae_v_len(1, crows),
                              v);
                  }
                ae_v_add(&c->ptr.pp_double[ci1][k],
                         c->stride,
                         &work->ptr.p_double[1],
                         1,
                         ae_v_len(ci1, ci2));
            ...
            for (l = aj1; l <= aj2; l++)
              {
                ...
                ae_v_move(&work->ptr.p_double[1],
                          1,
                          &a->ptr.pp_double[ai1][l],
                          a->stride,
                          ae_v_len(1, k));
                for (r = bi1; r <= bi2; r++)
                  {
                    v = ae_v_dotproduct(&work->ptr.p_double[1],
                                        1,
                                        &b->ptr.pp_double[r][bj1],
                                        1,
                                        ae_v_len(1, k));
  ...
  void
  hermitianmatrixvectormultiply(/* Complex */ ae_matrix *a,
                                ae_bool                  isupper,
                                ae_int_t                 i1,
                                ae_int_t                 i2,
                                /* Complex */ ae_vector *x,
        ...
        for (i = i1; i <= i2 - 1; i++)
          {
            ...
            ba1 = i + 1;
            ba2 = i2;
            ae_v_caddc(&y->ptr.p_complex[by1],
                       1,
                       &a->ptr.pp_complex[i][ba1],
                       1,
                       "Conj",
                       ae_v_len(by1, by2),
                       v);
            ...
            ba1 = i + 1;
            ba2 = i2;
            v   = ae_v_cdotproduct(&x->ptr.p_complex[bx1],
                                 1,
                                 "N",
                                 &a->ptr.pp_complex[i][ba1],
                                 1,
  ...
  void
  hermitianrank2update(/* Complex */ ae_matrix *a,
                       ae_bool                  isupper,
                       ae_int_t                 i1,
                       ae_int_t                 i2,
                       /* Complex */ ae_vector *x,
        ...
        for (i = i1; i <= i2; i++)
          {
            ...
            ae_v_cmovec(&t->ptr.p_complex[tp1],
                        1,
                        &y->ptr.p_complex[tp1],
                        1,
                        "Conj",
                        ...
                        v);
            v =
              ae_c_mul(ae_c_conj(alpha, _state), y->ptr.p_complex[i + 1 - i1]);
            ae_v_caddc(&t->ptr.p_complex[tp1],
                       1,
                       &x->ptr.p_complex[tp1],
                       1,
                       "Conj",
                       ae_v_len(tp1, tp2),
                       v);
            ae_v_cadd(&a->ptr.pp_complex[i][i],
                      1,
                      &t->ptr.p_complex[tp1],
                      1,
                      "N",
        ...
        for (i = i1; i <= i2; i++)
          {
            ...
            ae_v_caddc(&t->ptr.p_complex[tp1],
                       ...
                       ae_v_len(tp1, tp2),
                       v);
            ae_v_cadd(&a->ptr.pp_complex[i][i1],
                      1,
                      &t->ptr.p_complex[tp1],
                      1,
                      "N",
  ...
  *************************************************************************/
  void
  generatereflection(/* Real    */ ae_vector *x,
                     ae_int_t                 n,
                     double *                 tau,
                     ae_state *               _state)
  {
    ...
    *tau = 0;
    ...
    beta =
      -mx *
      ae_sqrt(ae_sqr(alpha / mx, _state) + ae_sqr(xnorm / mx, _state), _state);
  ...
  transformation which is given by column V and scalar Tau (see the description
  of the GenerateReflection procedure). Not the whole matrix but only a part of
  it is transformed (rows from M1 to M2, columns from N1 to N2). Only the
  ...
  *************************************************************************/
  void
  applyreflectionfromtheleft(/* Real    */ ae_matrix *c,
                             double                   tau,
                             /* Real    */ ae_vector *v,
                             ae_int_t                 m1,
                             ae_int_t                 m2,
    ...
    for (i = m1; i <= m2; i++)
      {
        ...
        ae_v_addd(&work->ptr.p_double[n1],
                  1,
                  &c->ptr.pp_double[i][n1],
                  1,
                  ae_v_len(n1, n2),
                  t);
      }
    ...
    for (i = m1; i <= m2; i++)
      {
        ...
        ae_v_subd(&c->ptr.pp_double[i][n1],
                  1,
                  &work->ptr.p_double[n1],
                  1,
                  ae_v_len(n1, n2),
                  t);
      }
  ...
  *************************************************************************/
  void
  applyreflectionfromtheright(/* Real    */ ae_matrix *c,
                              double                   tau,
                              /* Real    */ ae_vector *v,
                              ae_int_t                 m1,
                              ae_int_t                 m2,
                              ...
                              ae_state *               _state)
  {
    ...
    for (i = m1; i <= m2; i++)
      {
        t = ae_v_dotproduct(&c->ptr.pp_double[i][n1],
                            1,
                            &v->ptr.p_double[1],
                            1,
                            ae_v_len(n1, n2));
  ...
  *************************************************************************/
  void
  complexgeneratereflection(/* Complex */ ae_vector *x,
                            ae_int_t                 n,
                            ae_complex *             tau,
                            ae_state *               _state)
  {
  ...
  *************************************************************************/
  void
  complexapplyreflectionfromtheleft(/* Complex */ ae_matrix *c,
                                    ae_complex               tau,
                                    /* Complex */ ae_vector *v,
                                    ae_int_t                 m1,
                                    ae_int_t                 m2,
    ...
    for (i = m1; i <= m2; i++)
      {
        ...
        ae_v_caddc(&work->ptr.p_complex[n1],
                   1,
                   &c->ptr.pp_complex[i][n1],
                   1,
                   "N",
                   ae_v_len(n1, n2),
                   t);
    ...
    for (i = m1; i <= m2; i++)
      {
        ...
        ae_v_csubc(&c->ptr.pp_complex[i][n1],
                   1,
                   &work->ptr.p_complex[n1],
                   1,
                   "N",
                   ae_v_len(n1, n2),
                   t);
  ...
  *************************************************************************/
  void
  complexapplyreflectionfromtheright(/* Complex */ ae_matrix *c,
                                     ae_complex               tau,
                                     /* Complex */ ae_vector *v,
                                     ae_int_t                 m1,
                                     ae_int_t                 m2,
                                     ...
                                     ae_state *               _state)
  {
    ...
    for (i = m1; i <= m2; i++)
      {
        t                      = ae_v_cdotproduct(&c->ptr.pp_complex[i][n1],
                             1,
                             "N",
                             &v->ptr.p_complex[1],
                             1,
  ...
  void
  symmetricmatrixvectormultiply(/* Real    */ ae_matrix *a,
                                ae_bool                  isupper,
                                ae_int_t                 i1,
                                ae_int_t                 i2,
                                /* Real    */ ae_vector *x,
        ...
        for (i = i1; i <= i2 - 1; i++)
          {
            ...
            ba1 = i + 1;
            ba2 = i2;
            ae_v_addd(&y->ptr.p_double[by1],
                      1,
                      &a->ptr.pp_double[i][ba1],
                      1,
                      ae_v_len(by1, by2),
                      v);
            ...
            ba1                         = i + 1;
            ba2                         = i2;
            v                           = ae_v_dotproduct(&x->ptr.p_double[bx1],
                                1,
                                &a->ptr.pp_double[i][ba1],
                                1,
                                ae_v_len(bx1, bx2));
  ...
  void
  symmetricrank2update(/* Real    */ ae_matrix *a,
                       ae_bool                  isupper,
                       ae_int_t                 i1,
                       ae_int_t                 i2,
                       /* Real    */ ae_vector *x,
  ...
  of the IsForward parameter either 1 and 2, 3 and 4 and so on (if
  IsForward=true) rows are rotated, or the rows N and N-1, N-2 and N-3 and so
  on, are rotated.
  ...
  *************************************************************************/
  void
  applyrotationsfromtheleft(ae_bool                  isforward,
                            ae_int_t                 m1,
                            ae_int_t                 m2,
                            ae_int_t                 n1,
                            ae_int_t                 n2,
            ...
            for (j = m1; j <= m2 - 1; j++)
              {
                ...
                if (ae_fp_neq(ctemp, 1) || ae_fp_neq(stemp, 0))
                  {
                    jp1 = j + 1;
                    ae_v_moved(&work->ptr.p_double[n1],
                               1,
                               &a->ptr.pp_double[jp1][n1],
                               1,
                               ae_v_len(n1, n2),
                               ctemp);
                    ae_v_subd(&work->ptr.p_double[n1],
                              1,
                              &a->ptr.pp_double[j][n1],
                              1,
                              ae_v_len(n1, n2),
                              stemp);
                    ae_v_muld(&a->ptr.pp_double[j][n1],
                              1,
                              ae_v_len(n1, n2),
                              ctemp);
                    ae_v_addd(&a->ptr.pp_double[j][n1],
                              1,
                              &a->ptr.pp_double[jp1][n1],
                              1,
                              ae_v_len(n1, n2),
                              stemp);
                    ae_v_move(&a->ptr.pp_double[jp1][n1],
                              1,
                              &work->ptr.p_double[n1],
                              1,
                              ae_v_len(n1, n2));
  ...
  transformations which is given by arrays C and S. Depending on the value
  of the IsForward parameter either 1 and 2, 3 and 4 and so on (if
  IsForward=true) rows are rotated, or the rows N and N-1, N-2 and N-3 and so on
  are rotated.

  Not the whole matrix but only a part of it is transformed (rows from M1
  to M2, columns from N1 to N2). Only the elements of this submatrix are
  changed.
  ...
  *************************************************************************/
  void
  applyrotationsfromtheright(ae_bool                  isforward,
                             ae_int_t                 m1,
                             ae_int_t                 m2,
                             ae_int_t                 n1,
                             ae_int_t                 n2,
            ...
            for (j = n1; j <= n2 - 1; j++)
              {
                ...
                if (ae_fp_neq(ctemp, 1) || ae_fp_neq(stemp, 0))
                  {
                    jp1 = j + 1;
                    ae_v_moved(&work->ptr.p_double[m1],
                               1,
                               &a->ptr.pp_double[m1][jp1],
                               a->stride,
                               ae_v_len(m1, m2),
                               ctemp);
                    ae_v_subd(&work->ptr.p_double[m1],
                              1,
                              &a->ptr.pp_double[m1][j],
                              a->stride,
                              ae_v_len(m1, m2),
                              stemp);
                    ae_v_muld(&a->ptr.pp_double[m1][j],
                              a->stride,
                              ae_v_len(m1, m2),
                              ctemp);
                    ae_v_addd(&a->ptr.pp_double[m1][j],
                              ...
                              ae_v_len(m1, m2),
                              stemp);
                    ae_v_move(&a->ptr.pp_double[m1][jp1],
                              a->stride,
                              &work->ptr.p_double[m1],
                              1,
                              ae_v_len(m1, m2));
                  }
              }
  ...
  *************************************************************************/
  ae_bool
  upperhessenbergschurdecomposition(/* Real    */ ae_matrix *h,
                                    ae_int_t                 n,
                                    /* Real    */ ae_matrix *s,
                                    ae_state *               _state)
  {
  ...
  void
  internalschurdecomposition(/* Real    */ ae_matrix *h,
                             ae_int_t                 n,
                             ae_int_t                 tneeded,
                             ae_int_t                 zneeded,
                             /* Real    */ ae_vector *wr,
    ...
    if ((ns <= 2 || ns > n) || maxb >= n)
      {
         ...
         */
        hsschur_internalauxschur(wantt,
                                 wantz,
                                 n,
                                 1,
                                 n,
        ...
        for (its = 0; its <= itn; its++)
          {
            ...
            if (its == 20 || its == 30)
            ...
            else
              {
                 ...
                 */
                copymatrix(
                  h, i - ns + 1, i, i - ns + 1, i, &s, 1, ns, 1, ns, _state);
                hsschur_internalauxschur(ae_false,
                                         ae_false,
                                         ns,
                                         1,
                                         ns,
                    ...
                    if (ae_fp_eq(wi->ptr.p_double[j], 0))
                      {
                         ...
                         */
                        p1 = nv + 1;
                        ae_v_move(&vv.ptr.p_double[1],
                                  1,
                                  &v.ptr.p_double[1],
                                  1,
                                  ae_v_len(1, p1));
                        matrixvectormultiply(h,
                                             l,
                                             l + nv,
                                             l,
                                             l + nv - 1,
                        ...
                        if (ae_fp_greater(wi->ptr.p_double[j], 0))
                          {
                            ...
                            temp =
                              1 / ae_maxreal(ae_fabs(vv.ptr.p_double[itemp],
                                                     _state),
                                             smlnum,
                                             _state);
                            p1 = nv + 1;
                            ae_v_muld(&vv.ptr.p_double[1],
                                      1,
                                      ae_v_len(1, p1),
                                      temp);
                            absw = pythag2(wr->ptr.p_double[j],
                                           wi->ptr.p_double[j],
                                           _state);
                            temp = temp * absw * absw;
                            matrixvectormultiply(h,
            ...
            for (k = l; k <= i - 1; k++)
              {
                ...
                if (k > l)
                  {
                    p1 = k - 1;
                    p2 = k + nr - 1;
                    ae_v_move(&v.ptr.p_double[1],
                              1,
                              &h->ptr.pp_double[k][p1],
                              h->stride,
                              ae_v_len(1, nr));
                  }
                ...
                applyreflectionfromtheleft(
                  h, tau, &v, k, k + nr - 1, k, i2, &work, _state);

                /*
                 * Apply G from the right to transform the columns of the
                 * matrix in rows I1 to min(K+NR,I).
                 */
                applyreflectionfromtheright(h,
                                            tau,
                                            &v,
                                            i1,
                                            ae_minint(k + nr, i, _state),
                                            k,
                                            k + nr - 1,
                                            &work,
                                            _state);
                if (wantz)
                  {
                    ...
                    applyreflectionfromtheright(
                      z, tau, &v, 1, n, k, k + nr - 1, &work, _state);
                  }
              }
          }
        ...
        for (its = 0; its <= itn; its++)
          {
            ...
            if (its == 10 || its == 20)
            ...
            else
              {
                ...
                h43h34 =
                  h->ptr.pp_double[i][i - 1] * h->ptr.pp_double[i - 1][i];
                s = h->ptr.pp_double[i - 1][i - 2] *
                    h->ptr.pp_double[i - 1][i - 2];
                disc = (h33 - h44) * 0.5;
                ...
                if (ae_fp_greater(disc, 0))
                  {
                    ...
                    ave  = 0.5 * (h33 + h44);
                    if (ae_fp_greater(ae_fabs(h33, _state) -
                                        ae_fabs(h44, _state),
                                      0))
                      {
                        h33 = h33 * h44 - h43h34;
                        h44 =
                          h33 / (hsschur_extschursign(disc, ave, _state) + ave);
                      }
                    else
                      {
            ...
            for (m = i - 2; m >= l; m--)
              {
                ...
                s    = ae_fabs(v1, _state) + ae_fabs(v2, _state) +
                    ae_fabs(v3, _state);
                v1                      = v1 / s;
                v2                      = v2 / s;
                v3                      = v3 / s;
                ...
                tst1 = ae_fabs(v1, _state) *
                       (ae_fabs(h00, _state) + ae_fabs(h11, _state) +
                        ae_fabs(h22, _state));
                ...
                if (k > m)
                  {
                    for (p1 = 1; p1 <= nr; p1++)
                      {
                        workv3->ptr.p_double[p1] =
                          h->ptr.pp_double[k + p1 - 1][k - 1];
                      }
                  }
                    ...
                    if (wantz)
                      {
                        ...
                        for (j = iloz; j <= ihiz; j++)
                          {
                            sum = z->ptr.pp_double[j][k] +
                                  v2 * z->ptr.pp_double[j][k + 1] +
        ...
        if (l == i)
        ...
        else
          {
            if (l == i - 1)
              {
                /*
                 * H(I-1,I-2) is negligible: a pair of eigenvalues have
                 * converged.
                 *
                ...
                if (wantt)
                  {
                    ...
                    if (i2 > i)
                      {
                        ...
                        applyrotationsfromtheleft(ae_true,
                                                  i - 1,
                                                  i,
                                                  i + 1,
                                                  i2,
                    ...
                    workc1->ptr.p_double[1] = cs;
                    works1->ptr.p_double[1] = sn;
                    applyrotationsfromtheright(ae_true,
                                               i1,
                                               i - 2,
                                               i - 1,
                                               i,
        ...
        else
          {
            if (ae_fp_eq(*a - (*d), 0) &&
            ...
            else
              {
                ...
                p    = 0.5 * temp;
                bcmax =
                  ae_maxreal(ae_fabs(*b, _state), ae_fabs(*c, _state), _state);
                bcmis =
                  ae_minreal(ae_fabs(*b, _state), ae_fabs(*c, _state), _state) *
                  hsschur_extschursigntoone(*b, _state) *
                  hsschur_extschursigntoone(*c, _state);
                ...
                if (ae_fp_greater_eq(z, multpl * eps))
                  {
                     ...
                     */
                    z  = p + hsschur_extschursign(ae_sqrt(scl, _state) *
                                                   ae_sqrt(z, _state),
                                                 p,
                                                 _state);
                    *a = *d + z;
                ...
                else
                  {
                    ...
                    *cs =
                      ae_sqrt(0.5 * (1 + ae_fabs(sigma, _state) / tau), _state);
                    *sn = -p / (tau * (*cs)) *
                          hsschur_extschursign(1, sigma, _state);
                        ...
                        if (ae_fp_neq(*b, 0))
                          {
                            if (hsschur_extschursigntoone(*b, _state) ==
                                hsschur_extschursigntoone(*c, _state))
                              {
                                ...
                                tau  = 1 / ae_sqrt(ae_fabs(*b + (*c), _state),
                                                  _state);
                                *a   = temp + p;
                                *d   = temp - p;
                                *b   = *b - (*c);
  ...
  system. Array whose index ranges within [0..N-1]. IsUpper -   matrix type. If
  it is True, the system matrix is the upper triangular and is located in  the
  ...
  *************************************************************************/
  void
  rmatrixtrsafesolve(/* Real    */ ae_matrix *a,
                     ae_int_t                 n,
                     /* Real    */ ae_vector *x,
                     double *                 s,
                     ae_bool                  isupper,
                     ...
                     ae_state *               _state)
  {
    ...
    *s = 0;
    ...
    for (i = 1; i <= n; i++)
      {
        ae_v_move(&a1.ptr.pp_double[i][1],
                  1,
                  &a->ptr.pp_double[i - 1][0],
                  1,
                  ae_v_len(1, n));
      }
     ...
     */
    safesolvetriangular(
      &a1, n, &x1, s, isupper, istrans, isunit, normin, &cnorm, _state);

    /*
     * From 1-based to 0-based
     */
    ae_v_move(
      &x->ptr.p_double[0], 1, &x1.ptr.p_double[1], 1, ae_v_len(0, n - 1));
    ae_frame_leave(_state);
  }
  ...
  *************************************************************************/
  void
  safesolvetriangular(/* Real    */ ae_matrix *a,
                      ae_int_t                 n,
                      /* Real    */ ae_vector *x,
                      double *                 s,
                      ae_bool                  isupper,
        ...
        else
          {
            if (nounit)
                ...
                while ((jinc > 0 && j <= jlast) || (jinc < 0 && j >= jlast))
                  {
                    ...
                    xbnd = ae_minreal(xbnd,
                                      ae_minreal(1, tjj, _state) * grow,
                                      _state);
            ...
            else
              {
                 ...
                 */
                grow =
                  ae_minreal(1, 1 / ae_maxreal(xbnd, smlnum, _state), _state);
                j = jfirst;
                while ((jinc > 0 && j <= jlast) || (jinc < 0 && j >= jlast))
                  {
                    /*
            ...
            for (i = n - 1; i >= 1; i--)
              {
                ...
                if (upper)
                  {
                    v = ae_v_dotproduct(&a->ptr.pp_double[i][ip1],
                                        1,
                                        &x->ptr.p_double[ip1],
                                        1,
                                        ae_v_len(ip1, n));
                  ...
                  {
                    v = ae_v_dotproduct(&a->ptr.pp_double[ip1][i],
                                        a->stride,
                                        &x->ptr.p_double[ip1],
                                        1,
                                        ae_v_len(ip1, n));
            ...
            for (i = 2; i <= n; i++)
              {
                ...
                if (upper)
                  {
                    v = ae_v_dotproduct(&a->ptr.pp_double[1][i],
                                        a->stride,
                                        &x->ptr.p_double[1],
                                        1,
                                        ae_v_len(1, im1));
                  ...
                  {
                    v = ae_v_dotproduct(&a->ptr.pp_double[i][1],
                                        1,
                                        &x->ptr.p_double[1],
                                        1,
                                        ae_v_len(1, im1));
                    ...
                    if (j < n)
                      {
                        ...
                        jp1 = j + 1;
                        v   = x->ptr.p_double[j] * tscal;
                        ae_v_subd(&x->ptr.p_double[jp1],
                                  1,
                                  &a->ptr.pp_double[jp1][j],
                                  a->stride,
                                  ae_v_len(jp1, n),
                                  v);
                        i = j + 1;
            ...
            while ((jinc > 0 && j <= jlast) || (jinc < 0 && j >= jlast))
              {
                    ...
                    if (upper)
                      {
                        if (j > 1)
                          {
                            jm1  = j - 1;
                            sumj = ae_v_dotproduct(&a->ptr.pp_double[1][j],
                                                   a->stride,
                                                   &x->ptr.p_double[1],
                                                   1,
                                                   ae_v_len(1, jm1));
                    ...
                    else
                      {
                        if (j < n)
                          {
                            jp1  = j + 1;
                            sumj = ae_v_dotproduct(&a->ptr.pp_double[jp1][j],
                                                   a->stride,
                                                   &x->ptr.p_double[jp1],
                                                   1,
                                                   ae_v_len(jp1, n));
                ...
                xmax =
                  ae_maxreal(xmax, ae_fabs(x->ptr.p_double[j], _state), _state);
                j = j + jinc;
              }
          }
        *s = *s / tscal;
  ...
  *************************************************************************/
  ae_bool
  rmatrixscaledtrsafesolve(/* Real    */ ae_matrix *a,
                           double                   sa,
                           ae_int_t                 n,
                           /* Real    */ ae_vector *x,
                           ae_bool                  isupper,
                           ...
                           ae_state *               _state)
  {
    ...
    ae_assert(trans == 0 || trans == 1,
              "RMatrixTRSafeSolve: incorrect Trans!",
              _state);
    result = ae_true;
        ...
        for (i = n - 1; i >= 0; i--)
          {
            ...
            if (i < n - 1)
              {
                ae_v_moved(&tmp.ptr.p_double[i + 1],
                           1,
                           &a->ptr.pp_double[i][i + 1],
                           1,
                           ae_v_len(i + 1, n - 1),
                           sa);
                vr   = ae_v_dotproduct(&tmp.ptr.p_double[i + 1],
                                     1,
                                     &x->ptr.p_double[i + 1],
                                     1,
                                     ae_v_len(i + 1, n - 1));
        ...
        for (i = 0; i <= n - 1; i++)
          {
            ...
            if (i > 0)
              {
                ae_v_moved(&tmp.ptr.p_double[0],
                           1,
                           &a->ptr.pp_double[i][0],
                           1,
                           ae_v_len(0, i - 1),
                           sa);
                vr   = ae_v_dotproduct(&tmp.ptr.p_double[0],
                                     1,
                                     &x->ptr.p_double[0],
                                     1,
                                     ae_v_len(0, i - 1));
            ...
            if (i < n - 1)
              {
                ...
                ae_v_moved(&tmp.ptr.p_double[i + 1],
                           ...
                           ae_v_len(i + 1, n - 1),
                           sa);
                ae_v_subd(&x->ptr.p_double[i + 1],
                          1,
                          &tmp.ptr.p_double[i + 1],
                          1,
                          ae_v_len(i + 1, n - 1),
                          vr);
              }
  ...
  *************************************************************************/
  ae_bool
  cmatrixscaledtrsafesolve(/* Complex */ ae_matrix *a,
                           double                   sa,
                           ae_int_t                 n,
                           /* Complex */ ae_vector *x,
                           ae_bool                  isupper,
        ...
        for (i = n - 1; i >= 0; i--)
          {
            ...
            if (i < n - 1)
              {
                ae_v_cmoved(&tmp.ptr.p_complex[i + 1],
                            1,
                            &a->ptr.pp_complex[i][i + 1],
                            1,
                            "N",
                            ae_v_len(i + 1, n - 1),
                            sa);
        ...
        for (i = 0; i <= n - 1; i++)
          {
            ...
            if (i > 0)
              {
                ae_v_cmoved(&tmp.ptr.p_complex[0],
                            1,
                            &a->ptr.pp_complex[i][0],
                            1,
                            "N",
                            ae_v_len(0, i - 1),
                            sa);
                vc   = ae_v_cdotproduct(&tmp.ptr.p_complex[0],
                                      1,
                                      "N",
                                      &x->ptr.p_complex[0],
                                      1,
            ...
            if (i < n - 1)
              {
                ae_v_cmoved(&tmp.ptr.p_complex[i + 1],
                            ...
                            ae_v_len(i + 1, n - 1),
                            sa);
                ae_v_csubc(&x->ptr.p_complex[i + 1],
                           1,
                           &tmp.ptr.p_complex[i + 1],
                           1,
                           "N",
                           ae_v_len(i + 1, n - 1),
                           vc);
  ...
  Parameters:
      ...
      XNorm   -   inf-norm of other components of X (which are already
  processed) it is updated by CBasicSolveAndUpdate. X       -   solution
  ...
  *************************************************************************/
  void
  linminnormalized(/* Real    */ ae_vector *d,
                   double *                 stp,
                   ae_int_t                 n,
                   ae_state *               _state)
  {
    ...
    *stp = *stp / s;
     ...
     */
    s = ae_v_dotproduct(
      &d->ptr.p_double[0], 1, &d->ptr.p_double[0], 1, ae_v_len(0, n - 1));
        ...
        if (*stage == 2)
          {
            ...
            *info        = 0;
            ...
            if (((((((n <= 0 || ae_fp_less_eq(*stp, 0)) ||
                     ae_fp_less(linmin_ftol, 0)) ||
             ...
             */
            v             = ae_v_dotproduct(&g->ptr.p_double[0],
                                1,
                                &s->ptr.p_double[0],
                                1,
                                ae_v_len(0, n - 1));
        ...
        if (*stage == 4)
          {
            ...
            *nfev         = *nfev + 1;
            ...
            if ((ae_fp_eq(*stp, stpmax) && ae_fp_less_eq(*f, state->ftest1)) &&
            ...
            if (ae_fp_less_eq(*f, state->ftest1) &&
            ...
            if ((state->stage1 && ae_fp_less_eq(*f, state->ftest1)) &&
                ae_fp_greater_eq(state->dg,
                                 ae_minreal(linmin_ftol, gtol, _state) *
                                   state->dginit))
              {
  ...
  *************************************************************************/
               ...
               ae_state *               _state)
  {
    ...
    ae_v_move(&state->xbase.ptr.p_double[0],
              ...
              ae_v_len(0, n - 1));
    ae_v_move(
      &state->s.ptr.p_double[0], 1, &s->ptr.p_double[0], 1, ae_v_len(0, n - 1));
  ...
  *************************************************************************/
  ae_bool
  armijoiteration(armijostate *state, ae_state *_state)
  {
    double   v;
    ae_int_t n;
    ae_bool  result;
     ...
     * Routine body
     */
    if ((ae_fp_less_eq(state->stplen, 0) || ae_fp_less(state->stpmax, 0)) ||
        state->fmax < 2)
      {
        state->info = 0;
        result      = ae_false;
  ...
  *************************************************************************/
  void
  armijoresults(armijostate *state,
                ae_int_t *   info,
                double *     stp,
                double *     f,
                ae_state *   _state)
  ...
  ae_bool
  _linminstate_init(void *_p, ae_state *_state, ae_bool make_automatic)
  {
  ...
  ae_bool
  _linminstate_init_copy(void *    _dst,
                         void *    _src,
                         ae_state *_state,
                         ae_bool   make_automatic)
  {
  ...
  ae_bool
  _armijostate_init(void *_p, ae_state *_state, ae_bool make_automatic)
  {
  ...
  ae_bool
  _armijostate_init_copy(void *    _dst,
                         void *    _src,
                         ae_state *_state,
                         ae_bool   make_automatic)
  {
  ...
  *************************************************************************/
  void
  ftbasegeneratecomplexfftplan(ae_int_t n, ftplan *plan, ae_state *_state)
  {
    ae_int_t planarraysize;
    ae_int_t plansize;
    ae_int_t precomputedsize;
    ...
    ftbase_ftbasegenerateplanrec(n,
                                 ...
                                 stackptr,
                                 _state);
    ae_assert(stackptr == 0,
              "Internal error in FTBaseGenerateComplexFFTPlan: stack ptr!",
              _state);
    ae_vector_set_length(&plan->stackbuf,
                         ae_maxint(stackmemsize, 1, _state),
                         _state);
    ae_vector_set_length(&plan->tmpbuf,
                         ae_maxint(tmpmemsize, 1, _state),
                         _state);
    ae_vector_set_length(&plan->precomputed,
                         ae_maxint(precomputedsize, 1, _state),
                         _state);
    stackptr = 0;
  ...
  *************************************************************************/
  void
  ftbasegeneraterealfftplan(ae_int_t n, ftplan *plan, ae_state *_state)
  {
    ae_int_t planarraysize;
    ae_int_t plansize;
    ae_int_t precomputedsize;
    ...
    ftbase_ftbasegenerateplanrec(n,
                                 ...
                                 _state);
    ae_assert(stackptr == 0,
              "Internal error in FTBaseGenerateRealFFTPlan: stack ptr!",
              _state);
    ae_vector_set_length(&plan->stackbuf,
                         ae_maxint(stackmemsize, 1, _state),
                         _state);
  ...
  *************************************************************************/
  void
  ftbasegeneraterealfhtplan(ae_int_t n, ftplan *plan, ae_state *_state)
  {
    ae_int_t planarraysize;
    ae_int_t plansize;
    ae_int_t precomputedsize;
    ...
    ftbase_ftbasegenerateplanrec(n,
                                 ...
                                 _state);
    ae_assert(stackptr == 0,
              "Internal error in FTBaseGenerateRealFHTPlan: stack ptr!",
              _state);
    ae_vector_set_length(&plan->stackbuf,
                         ae_maxint(stackmemsize, 1, _state),
                         _state);
  ...
  *************************************************************************/
  void
  ftbaseexecuteplan(/* Real    */ ae_vector *a,
                    ae_int_t                 aoffset,
                    ae_int_t                 n,
                    ftplan *                 plan,
                    ae_state *               _state)
  ...
  *************************************************************************/
  void
  ftbaseexecuteplanrec(/* Real    */ ae_vector *a,
                       ae_int_t                 aoffset,
                       ftplan *                 plan,
                       ae_int_t                 entryoffset,
                       ae_int_t                 stackptr,
    ...
    if (plan->plan.ptr.p_int[entryoffset + 3] == ftbase_fftcooleytukeyplan)
      {
        ...
        ftbase_internalcomplexlintranspose(
          a, n1, n2, aoffset, &plan->tmpbuf, _state);
        for (i = 0; i <= n2 - 1; i++)
          {
            ftbaseexecuteplanrec(a,
                                 aoffset + i * n1 * 2,
                                 plan,
                                 plan->plan.ptr.p_int[entryoffset + 5],
                                 stackptr,
                                 _state);
          }
        ftbase_ffttwcalc(a, aoffset, n1, n2, _state);
        ftbase_internalcomplexlintranspose(
          a, n2, n1, aoffset, &plan->tmpbuf, _state);
        for (i = 0; i <= n1 - 1; i++)
          {
            ftbaseexecuteplanrec(a,
                                 aoffset + i * n2 * 2,
                                 plan,
                                 plan->plan.ptr.p_int[entryoffset + 6],
                                 stackptr,
                                 _state);
          }
        ftbase_internalcomplexlintranspose(
        ...
        for (i = 0; i <= n1 / 2 - 1; i++)
          {
            ...
            for (k = 0; k <= n2 - 1; k++)
              {
                a->ptr.p_double[offs + 2 * k + 1] =
                  a->ptr.p_double[offs + 2 * n2 + 2 * k + 0];
              }
            ftbaseexecuteplanrec(a,
                                 offs,
                                 plan,
            ...
            ae_v_move(&a->ptr.p_double[offs],
                      1,
                      &plan->tmpbuf.ptr.p_double[0],
                      1,
                      ae_v_len(offs, offs + 2 * n2 * 2 - 1));
          }
        if (n1 % 2 != 0)
          {
            ftbaseexecuteplanrec(a,
    ...
    if (plan->plan.ptr.p_int[entryoffset + 3] == ftbase_fhtcooleytukeyplan)
      {
        ...
        n2 = plan->plan.ptr.p_int[entryoffset + 2];
        n  = n1 * n2;
        ftbase_internalreallintranspose(
          a, n1, n2, aoffset, &plan->tmpbuf, _state);
        for (i = 0; i <= n2 - 1; i++)
          {
            ftbaseexecuteplanrec(a,
        ...
        for (j = 0; j <= n1 - 1; j++)
          {
            a->ptr.p_double[aoffset + j] =
              plan->tmpbuf.ptr.p_double[2 * j + 0] +
              plan->tmpbuf.ptr.p_double[2 * j + 1];
          }
        if (n2 % 2 == 0)
          {
            offs  = 2 * (n2 / 2) * n1;
            ...
            for (j = 0; j <= n1 - 1; j++)
              {
                a->ptr.p_double[offsa + j] =
                  plan->tmpbuf.ptr.p_double[offs + 2 * j + 0] +
                  plan->tmpbuf.ptr.p_double[offs + 2 * j + 1];
              }
          }
            ...
            for (j = 0; j <= n1 - 1; j++)
              {
                a->ptr.p_double[offsa + j] =
                  plan->tmpbuf.ptr.p_double[offs + 2 * j + 1] +
                  plan->tmpbuf.ptr.p_double[offs2 + 2 * j + 0];
              }
            ...
            for (j = 0; j <= n1 - 1; j++)
              {
                a->ptr.p_double[offsa + j] =
                  plan->tmpbuf.ptr.p_double[offs + 2 * j + 0] +
                  plan->tmpbuf.ptr.p_double[offs2 + 2 * j + 1];
              }
          }
        ftbase_internalreallintranspose(
          a, n2, n1, aoffset, &plan->tmpbuf, _state);
    ...
    if (plan->plan.ptr.p_int[entryoffset + 3] == ftbase_fftbluesteinplan)
      {
        ...
        ftbaseexecuteplanrec(&plan->stackbuf,
                             stackptr,
                             plan,
                             plan->plan.ptr.p_int[entryoffset + 5],
                             stackptr + 2 * 2 * m,
  ...
  *************************************************************************/
  ae_bool
  ftbaseissmooth(ae_int_t n, ae_state *_state)
  {
    ae_int_t i;
    ae_bool  result;
  ...
  *************************************************************************/
  ae_int_t
  ftbasefindsmooth(ae_int_t n, ae_state *_state)
  {
    ae_int_t best;
    ae_int_t result;
  ...
  *************************************************************************/
  ae_int_t
  ftbasefindsmootheven(ae_int_t n, ae_state *_state)
  {
    ae_int_t best;
    ae_int_t result;
  ...
  *************************************************************************/
  double
  ftbasegetflopestimate(ae_int_t n, ae_state *_state)
  {
    double result;


    result = ftbase_ftbaseinefficiencyfactor *
             (4 * n * ae_log(n, _state) / ae_log(2, _state) - 6 * n + 8);
    return result;
  }
  ...
  *************************************************************************/
                               ...
                               ae_state *_state)
  {
    ...
    if (*plansize + ftbase_ftbaseplanentrysize > (*planarraysize))
      {
        ftbase_fftarrayresize(&plan->plan,
                              planarraysize,
                              8 * (*planarraysize),
                              _state);
      }
        ...
        if (n1 != 1)
          {
            ...
            *tmpmemsize = ae_maxint(*tmpmemsize, 2 * n1 * n2, _state);
            ...
            if (tasktype == ftbase_ftbasecffttask)
              {
                plan->plan.ptr.p_int[entryoffset + 3] =
                  ftbase_fftcooleytukeyplan;
              }
            else
              {
                plan->plan.ptr.p_int[entryoffset + 3] =
                  ftbase_fftrealcooleytukeyplan;
              }
  ...
  *************************************************************************/
                                 ...
                                 ae_state *_state)
  {
    ...
    if ((plan->plan.ptr.p_int[entryoffset + 3] == ftbase_fftcooleytukeyplan ||
        ...
        plan->plan.ptr.p_int[entryoffset + 3] == ftbase_fhtcooleytukeyplan)
      {
        ftbase_ftbaseprecomputeplanrec(plan,
                                       plan->plan.ptr.p_int[entryoffset + 5],
                                       stackptr,
                                       _state);
        ftbase_ftbaseprecomputeplanrec(plan,
    ...
    if (plan->plan.ptr.p_int[entryoffset + 3] == ftbase_fftcodeletplan ||
        plan->plan.ptr.p_int[entryoffset + 3] == ftbase_fhtcodeletplan)
      {
        ...
        if (n == 3)
          {
            offs = plan->plan.ptr.p_int[entryoffset + 7];
            plan->precomputed.ptr.p_double[offs + 0] =
              ae_cos(2 * ae_pi / 3, _state) - 1;
            plan->precomputed.ptr.p_double[offs + 1] =
              ae_sin(2 * ae_pi / 3, _state);
            ae_frame_leave(_state);
            return;
          }
        if (n == 5)
          {
            ...
            v    = 2 * ae_pi / 5;
            plan->precomputed.ptr.p_double[offs + 0] =
              (ae_cos(v, _state) + ae_cos(2 * v, _state)) / 2 - 1;
            plan->precomputed.ptr.p_double[offs + 1] =
              (ae_cos(v, _state) - ae_cos(2 * v, _state)) / 2;
            plan->precomputed.ptr.p_double[offs + 2] = -ae_sin(v, _state);
            plan->precomputed.ptr.p_double[offs + 3] =
              -(ae_sin(v, _state) + ae_sin(2 * v, _state));
            plan->precomputed.ptr.p_double[offs + 4] =
              ae_sin(v, _state) - ae_sin(2 * v, _state);
            ae_frame_leave(_state);
            return;
          }
    ...
    if (plan->plan.ptr.p_int[entryoffset + 3] == ftbase_fftbluesteinplan)
      {
        ...
        ftbaseexecuteplanrec(&plan->precomputed,
                             offs,
                             plan,
                             plan->plan.ptr.p_int[entryoffset + 5],
                             stackptr,
  ...
  *************************************************************************/
                                     ...
                                     ae_state *               _state)
  {
    ...
    ae_v_move(&a->ptr.p_double[astart],
              1,
              &buf->ptr.p_double[0],
              1,
    ...
    if (n > m)
      {
        ...
        ftbase_ffticltrec(
          a, astart, astride, b, bstart, bstride, m, n1, _state);
        ftbase_ffticltrec(a,
                          astart + 2 * n1,
                          astride,
                          b,
    ...
    else
      {
        ...
        ftbase_ffticltrec(
          a, astart, astride, b, bstart, bstride, m1, n, _state);
        ftbase_ffticltrec(a,
                          astart + 2 * m1 * astride,
                          astride,
                          b,
  ...
  *************************************************************************/
                             ...
                             ae_state *_state)
  {
    ae_assert(ftbase_ftbasemaxsmoothfactor <= 5,
              "FTBaseFindSmoothRec: internal error!",
              _state);
    if (seed >= n)
      {
  ...
  *************************************************************************/
    ...
    for (i = 0; i <= n - 1; i++)
      {
        ...
        for (j = 0; j <= n - 1; j++)
          {
            v = v + a->ptr.p_double[offs + j] *
                      (ae_cos(2 * ae_pi * i * j / n, _state) +
                       ae_sin(2 * ae_pi * i * j / n, _state));
          }
  ...
  ae_bool
  _ftplan_init(void *_p, ae_state *_state, ae_bool make_automatic)
  {
    ftplan *p = (ftplan *)_p;
    ae_touch_ptr((void *)p);
                    ...
                    ae_bool   make_automatic)
  {
    ...
    if (!ae_vector_init_copy(
          &dst->precomputed, &src->precomputed, _state, make_automatic))
      return ae_false;
    if (!ae_vector_init_copy(
          &dst->tmpbuf, &src->tmpbuf, _state, make_automatic))
      return ae_false;
    if (!ae_vector_init_copy(
          &dst->stackbuf, &src->stackbuf, _state, make_automatic))
      return ae_false;
    return ae_true;
  }
  ...
  double
  nulog1p(double x, ae_state *_state)
  {
    double z;
    double lp;
    double lq;
  ...
  double
  nuexpm1(double x, ae_state *_state)
  {
    double r;
    double xx;
    double ep;
  ...
  double
  nucosm1(double x, ae_state *_state)
  {
    double xx;
    double c;
    double result;
