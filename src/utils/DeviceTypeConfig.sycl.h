...
// ---------------------------------------------------------------------
//
#ifndef dftefeDeviceTypeConfig_syclh
#define dftefeDeviceTypeConfig_syclh
...
namespace dftefe
{
  namespace utils
  {
    ...
    inline std::set<dftefe::uInt> usedStreamIds{defaultStream};
  } // namespace utils
} // namespace dftefe

#endif // dftefeDeviceTypeConfig_syclh
