...
namespace dftefe
{
      ...
      if (threadId < dftefe::utils::DEVICE_WARP_SIZE)
        {
                                 ...
                                 offset /= 2)
          {
            ...
            localSum +=
              __shfl_down(localSum, offset, dftefe::utils::DEVICE_WARP_SIZE);
  ...
  applyPreconditionAndComputeDotProductDevice(double          *d_dvec,
                                              ...
                                              const size_type N)
  {
    const size_type blocks = (N + (dftefe::utils::DEVICE_BLOCK_SIZE * 2 - 1)) /
                              ...
                              const size_type N)
  {
    ...
    DFTEFE_LAUNCH_KERNEL_SMEM_S(
      DFTEFE_KERNEL_ARGUMENT(
        scaleXRandComputeNormKernel<double, dftefe::utils::DEVICE_BLOCK_SIZE>),
      blocks,
      dftefe::utils::DEVICE_BLOCK_SIZE,
      double,
      dftefe::utils::DEVICE_BLOCK_SIZE,
