    ...
    namespace basis
    {
        namespace EFEBasisDataStorgeDealiiInternal
        {
                ...
                const BasisStorageAttributesBoolMap basisStorageAttributesBoolMap)
            {
                ...
                const size_type numQuadPointsPerCell = utils::mathFunctions::sizeTypePow(num1DQuadPoints, dim);
                    ...
                    ++locallyOwnedCellIter)
                {
                    ...
                    *locallyOwnedCellIter);
                    ...
                    if (basisStorageAttributesBoolMap
                        ...
                        ->second )
                    {
                        cellStartIdsBasisQuadStorage[cellIndex] = cumulativeQuadPoints * dofsPerCell;
                                    ...
                                    for (unsigned int iDim = 0; iDim < dim; iDim++)
                                    {
                                        for (unsigned int jDim = 0; jDim < dim; jDim++)
                                        {
                                            ...
                                            cumulativeQuadPoints * dim * dim *
                                                dofsPerCell +
                                            iDim * dim * dofsPerCell * numQuadPointsPerCell +
                                            jDim * dofsPerCell * numQuadPointsPerCell +
                                            iNode * numQuadPointsPerCell + qPoint;
                    ...
                    const BasisStorageAttributesBoolMap basisStorageAttributesBoolMap)            
        {
            ...
            */
            ...
            storeJxWBool |= basisStorageAttributesBoolMap
                                ...
                                ->second;
            storeQuadRealPointsBool |= basisStorageAttributesBoolMap
