...
namespace dftefe
{
  ...
  namespace internal
  {
    ...
    fillRhoVector(
      ...
      const dftefe::utils::MemoryStorage<double, memorySpace> &densitySpinDown,
    ...
    fillRhoSigmaVector(
      ...
      const dftefe::utils::MemoryStorage<double, memorySpace> &densitySpinUp,
      const dftefe::utils::MemoryStorage<double, memorySpace> &densitySpinDown,
      const dftefe::utils::MemoryStorage<double, memorySpace> &gradDensitySpinUp,
      const dftefe::utils::MemoryStorage<double, memorySpace> &gradDensitySpinDown,
      dftefe::utils::MemoryStorage<double, memorySpace>       &rhoVector,
