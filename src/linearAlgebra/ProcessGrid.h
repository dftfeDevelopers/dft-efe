...
namespace dftefe
{
  namespace linearAlgebra
  {
    ...
    {
    public:
      // // Declare class ScaLAPACK as friend to provide access to private
      // members. template <typename NumberType> friend class ScaLAPACKMatrix;
       ...
       */
      ProcessGrid(const utils::mpi::MPIComm &mpi_communicator,
