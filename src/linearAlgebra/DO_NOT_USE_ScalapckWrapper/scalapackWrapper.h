...
namespace dftefeScalapack
{
  ...
  public:
     ...
     */
    void
    set_property(const dftefeScalapack::LAPACKSupport::Property property);
  ...
  private:
     ...
     * structures.
     */
    std::shared_ptr<const dftefeScalapack::ProcessGrid> grid;
