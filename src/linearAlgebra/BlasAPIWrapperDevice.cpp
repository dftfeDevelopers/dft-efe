    ...
    namespace blasLapack
    {
      namespace blasWrapper
      {
          ...
          LinAlgOpContext<utils::MemorySpace::DEVICE> &context)
        {
          ...
          DEVICEBLAS_API_CHECK(DFTEFE_DEVICE_BLAS_INT(, gemm)(context.getDeviceBlasHandle(),
                                                              transa,
                                                              transb,
                                                              m,
                                                              n,
          ...
          LinAlgOpContext<utils::MemorySpace::DEVICE> &context)
        {
          ...
          DEVICEBLAS_API_CHECK(DFTEFE_DEVICE_BLAS_INT(D, gemm)(context.getDeviceBlasHandle(),
                                                              transa,
                                                              transb,
                                                              m,
                                                              n,
          ...
          LinAlgOpContext<utils::MemorySpace::DEVICE> &context)
        {
          ...
          DEVICEBLAS_API_CHECK(DFTEFE_DEVICE_BLAS_INT(D, axpy)(context.getDeviceBlasHandle(),
                                                              nTmp,
                                                              &alpha,
                                                              x,
                                                              incxTmp,
          ...
          LinAlgOpContext<utils::MemorySpace::DEVICE> &                   context)
        {
          ...
          unsigned int incxTmp = incx;
          unsigned int incyTmp = incy;
          DEVICEBLAS_API_CHECK(DFTEFE_DEVICE_BLAS_INT(Z, axpy)(context.getDeviceBlasHandle(),
                                                              nTmp,
                                                              makeDataTypeDeviceBlasCompatible(&alpha),
