...
@rfm.simple_test
class BuildOnlyTestCGLinearSolverSerialHostComplexDouble(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestCGLinearSolverSerialHostComplexDouble using CMake'
    build_system = 'CMake'
    make_opts = ['TestCGLinearSolverSerialHostComplexDouble']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestCGLinearSolverSerialHostComplexDouble(rfm.RegressionTest):
    descr = '''Compile and run test for size of
    TestCGLinearSolverSerialHostComplexDouble'''
    build_system = 'CMake'
    make_opts = ['TestCGLinearSolverSerialHostComplexDouble']
    executable = './TestCGLinearSolverSerialHostComplexDouble.x'
    sourcesdir = './src'
    tagsDict = {'compileOrRun': 'compile', 'unitOrAggregate':
                'unit', 'slowOrFast': 'fast', 'arch': 'cpu',
                'serialOrParallel': 'serial'}
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = "Found error(s) in TestCGLinearSolverSerialHostComplexDouble."
...
@rfm.simple_test
class RunOnlyTestCGLinearSolverSerialHostComplexDouble(rfm.RunOnlyRegressionTest):
    descr = '''Run only test for size of SerialVector'''
    target_name = 'TestCGLinearSolverSerialHostComplexDouble'
    build_system = 'CMake'
