...
@rfm.simple_test
class BuildOnlyTestPoissonProblemEnrichment(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestPoissonProblemEnrichment'
    build_system = 'CMake'
    make_opts = ['TestPoissonProblemEnrichment']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestPoissonProblemEnrichment(rfm.RegressionTest):
    target_name = 'TestPoissonProblemEnrichment'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestPoissonProblemEnrichment.'''
...
@rfm.simple_test
class RunOnlyTestPoissonProblemEnrichment(rfm.RunOnlyRegressionTest):
    target_name = 'TestPoissonProblemEnrichment'
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        RunOnlyTestPoissonProblemEnrichment.'''
        msgThrownException = '''Found exceptions in
        RunOnlyTestPoissonProblemEnrichment'''
        msgAssertFail = '''Found assert fail(s) in
        RunOnlyTestPoissonProblemEnrichment'''
