...
@rfm.simple_test
class BuildOnlyTestTwoBodyInteraction(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestTwoBodyInteraction'
    build_system = 'CMake'
    make_opts = ['TestTwoBodyInteraction']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestTwoBodyInteraction(rfm.RegressionTest):
    target_name = 'TestTwoBodyInteraction'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestTwoBodyInteraction.'''
...
@rfm.simple_test
class RunOnlyTestTwoBodyInteraction(rfm.RunOnlyRegressionTest):
    target_name = 'TestTwoBodyInteraction'
