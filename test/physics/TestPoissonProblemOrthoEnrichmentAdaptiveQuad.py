...
@rfm.simple_test
class BuildOnlyTestPoissonProblemOrthoEnrichmentAdaptiveQuad(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestPoissonProblemOrthoEnrichmentAdaptiveQuad'
    build_system = 'CMake'
    make_opts = ['TestPoissonProblemOrthoEnrichmentAdaptiveQuad']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestPoissonProblemOrthoEnrichmentAdaptiveQuad(rfm.RegressionTest):
    target_name = 'TestPoissonProblemOrthoEnrichmentAdaptiveQuad'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestPoissonProblemOrthoEnrichmentAdaptiveQuad.'''
...
@rfm.simple_test
class RunOnlyTestPoissonProblemOrthoEnrichmentAdaptiveQuad(rfm.RunOnlyRegressionTest):
    target_name = 'TestPoissonProblemOrthoEnrichmentAdaptiveQuad'
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        RunOnlyTestPoissonProblemOrthoEnrichmentAdaptiveQuad.'''
        msgThrownException = '''Found exceptions in
        RunOnlyTestPoissonProblemOrthoEnrichmentAdaptiveQuad'''
        msgAssertFail = '''Found assert fail(s) in
        RunOnlyTestPoissonProblemOrthoEnrichmentAdaptiveQuad'''
