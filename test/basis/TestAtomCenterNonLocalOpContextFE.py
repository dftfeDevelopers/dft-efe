...
@rfm.simple_test
class BuildOnlyTestAtomCenterNonLocalOpContextFE(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestAtomCenterNonLocalOpContextFE'
    build_system = 'CMake'
    make_opts = ['TestAtomCenterNonLocalOpContextFE']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestAtomCenterNonLocalOpContextFE(rfm.RegressionTest):
    target_name = 'TestAtomCenterNonLocalOpContextFE'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestAtomCenterNonLocalOpContextFE.'''
...
@rfm.simple_test
class RunOnlyTestAtomCenterNonLocalOpContextFE(rfm.RunOnlyRegressionTest):
    target_name = 'TestAtomCenterNonLocalOpContextFE'
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        RunOnlyTestAtomCenterNonLocalOpContextFE.'''
        msgThrownException = '''Found exceptions in
        RunOnlyTestAtomCenterNonLocalOpContextFE'''
        msgAssertFail = '''Found assert fail(s) in
        RunOnlyTestAtomCenterNonLocalOpContextFE'''
