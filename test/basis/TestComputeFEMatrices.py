...
@rfm.simple_test
class BuildOnlyTestComputeFEMatrices(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestComputeFEMatrices'
    build_system = 'CMake'
    make_opts = ['TestComputeFEMatrices']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestComputeFEMatrices(rfm.RegressionTest):
    target_name = 'TestComputeFEMatrices'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestComputeFEMatrices.'''
...
@rfm.simple_test
class RunOnlyTestComputeFEMatrices(rfm.RunOnlyRegressionTest):
    target_name = 'TestComputeFEMatrices'
