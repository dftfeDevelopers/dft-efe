...
@rfm.simple_test
class BuildOnlyTestAtomIdsPartitionSerial(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestAtomIdsPartitionSerial'
    build_system = 'CMake'
    make_opts = ['TestAtomIdsPartitionSerial']
    sourcesdir = './src'
...
class BuildAndRunTestAtomIdsPartitionSerial(rfm.RegressionTest):
    ...
    def validate_test(self):
        ...
        BuildAndRunTestAtomIdsPartitionSerial.'''
...
class RunOnlyTestAtomIdsPartitionSerial(rfm.RunOnlyRegressionTest):
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        RunOnlyTestAtomIdsPartitionSerial.'''
        msgThrownException = '''Found exceptions in
        RunOnlyTestAtomIdsPartitionSerial'''
        msgAssertFail = '''Found assert fail(s) in
        RunOnlyTestAtomIdsPartitionSerial'''
