...
@rfm.simple_test
class BuildOnlyTestClassicalEnrichmentIdsMPICommunication(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestClassicalEnrichmentIdsMPICommunication'
    build_system = 'CMake'
    make_opts = ['TestClassicalEnrichmentIdsMPICommunication']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestClassicalEnrichmentIdsMPICommunication(rfm.RegressionTest):
    target_name = 'TestClassicalEnrichmentIdsMPICommunication'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestClassicalEnrichmentIdsMPICommunication.'''
...
@rfm.simple_test
class RunOnlyTestClassicalEnrichmentIdsMPICommunication(rfm.RunOnlyRegressionTest):
    target_name = 'TestClassicalEnrichmentIdsMPICommunication'
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        RunOnlyTestClassicalEnrichmentIdsMPICommunication.'''
        msgThrownException = '''Found exceptions in
        RunOnlyTestClassicalEnrichmentIdsMPICommunication'''
        msgAssertFail = '''Found assert fail(s) in
        RunOnlyTestClassicalEnrichmentIdsMPICommunication'''
