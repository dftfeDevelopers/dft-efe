...
@rfm.simple_test
class BuildOnlyTestOrthoEnrichmentBasisManager(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestOrthoEnrichmentBasisManager'
    build_system = 'CMake'
    make_opts = ['TestOrthoEnrichmentBasisManager']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestOrthoEnrichmentBasisManager(rfm.RegressionTest):
    target_name = 'TestOrthoEnrichmentBasisManager'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestOrthoEnrichmentBasisManager.'''
...
@rfm.simple_test
class RunOnlyTestOrthoEnrichmentBasisManager(rfm.RunOnlyRegressionTest):
    target_name = 'TestOrthoEnrichmentBasisManager'
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        RunOnlyTestOrthoEnrichmentBasisManager.'''
        msgThrownException = '''Found exceptions in
        RunOnlyTestOrthoEnrichmentBasisManager'''
        msgAssertFail = '''Found assert fail(s) in
        RunOnlyTestOrthoEnrichmentBasisManager'''
