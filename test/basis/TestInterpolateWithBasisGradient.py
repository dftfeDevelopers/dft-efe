...
@rfm.simple_test
class BuildOnlyTestInterpolateWithBasisGradient(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestInterpolateWithBasisGradient'
    build_system = 'CMake'
    make_opts = ['TestInterpolateWithBasisGradient']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestInterpolateWithBasisGradient(rfm.RegressionTest):
    target_name = 'TestInterpolateWithBasisGradient'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestInterpolateWithBasisGradient.'''
...
@rfm.simple_test
class RunOnlyTestInterpolateWithBasisGradient(rfm.RunOnlyRegressionTest):
    target_name = 'TestInterpolateWithBasisGradient'
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        RunOnlyTestInterpolateWithBasisGradient.'''
        msgThrownException = '''Found exceptions in
        RunOnlyTestInterpolateWithBasisGradient'''
        msgAssertFail = '''Found assert fail(s) in
        RunOnlyTestInterpolateWithBasisGradient'''
