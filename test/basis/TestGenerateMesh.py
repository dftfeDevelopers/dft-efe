...
@rfm.simple_test
class BuildOnlyTestGenerateMesh(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestGenerateMesh'
    build_system = 'CMake'
    make_opts = ['TestGenerateMesh']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestGenerateMesh(rfm.RegressionTest):
    target_name = 'TestGenerateMesh'
...
@rfm.simple_test
class RunOnlyTestGenerateMesh(rfm.RunOnlyRegressionTest):
    target_name = 'TestGenerateMesh'
