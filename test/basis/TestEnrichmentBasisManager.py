...
@rfm.simple_test
class BuildOnlyTestEnrichmentBasisManager(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestEnrichmentBasisManager'
    build_system = 'CMake'
    make_opts = ['TestEnrichmentBasisManager']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestEnrichmentBasisManager(rfm.RegressionTest):
    target_name = 'TestEnrichmentBasisManager'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestEnrichmentBasisManager.'''
...
@rfm.simple_test
class RunOnlyTestEnrichmentBasisManager(rfm.RunOnlyRegressionTest):
    target_name = 'TestEnrichmentBasisManager'
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        RunOnlyTestEnrichmentBasisManager.'''
        msgThrownException = '''Found exceptions in
        RunOnlyTestEnrichmentBasisManager'''
        msgAssertFail = '''Found assert fail(s) in
        RunOnlyTestEnrichmentBasisManager'''
