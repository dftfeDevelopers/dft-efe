...
@rfm.simple_test
class BuildOnlyTestPoissonSolverDealiiMatrixFreeFE(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestPoissonSolverDealiiMatrixFreeFE'
    build_system = 'CMake'
    make_opts = ['TestPoissonSolverDealiiMatrixFreeFE']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestPoissonSolverDealiiMatrixFreeFE(rfm.RegressionTest):
    target_name = 'TestPoissonSolverDealiiMatrixFreeFE'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestPoissonSolverDealiiMatrixFreeFE.'''
...
@rfm.simple_test
class RunOnlyTestPoissonSolverDealiiMatrixFreeFE(rfm.RunOnlyRegressionTest):
    target_name = 'TestPoissonSolverDealiiMatrixFreeFE'
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        RunOnlyTestPoissonSolverDealiiMatrixFreeFE.'''
        msgThrownException = '''Found exceptions in
        RunOnlyTestPoissonSolverDealiiMatrixFreeFE'''
        msgAssertFail = '''Found assert fail(s) in
        RunOnlyTestPoissonSolverDealiiMatrixFreeFE'''
