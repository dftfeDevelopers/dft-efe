...
@rfm.simple_test
class BuildOnlyTestFunctionClassical(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestFunctionClassical'
    build_system = 'CMake'
    make_opts = ['TestFunctionClassical']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestFunctionClassical(rfm.RegressionTest):
    target_name = 'TestFunctionClassical'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestFunctionClassical.'''
...
@rfm.simple_test
class RunOnlyTestFunctionClassical(rfm.RunOnlyRegressionTest):
    target_name = 'TestFunctionClassical'
