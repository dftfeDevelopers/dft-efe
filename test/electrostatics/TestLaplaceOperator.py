...
@rfm.simple_test
class BuildOnlyTestLaplaceOperator(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestLaplaceOperator'
    build_system = 'CMake'
    make_opts = ['TestLaplaceOperator']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestLaplaceOperator(rfm.RegressionTest):
    target_name = 'TestLaplaceOperator'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestLaplaceOperator.'''
...
@rfm.simple_test
class RunOnlyTestLaplaceOperator(rfm.RunOnlyRegressionTest):
    target_name = 'TestLaplaceOperator'
