...
@rfm.simple_test
class BuildOnlyTestPoissonProblemEnrichmentAdaptiveQuad(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestPoissonProblemEnrichmentAdaptiveQuad'
    build_system = 'CMake'
    make_opts = ['TestPoissonProblemEnrichmentAdaptiveQuad']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestPoissonProblemEnrichmentAdaptiveQuad(rfm.RegressionTest):
    target_name = 'TestPoissonProblemEnrichmentAdaptiveQuad'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestPoissonProblemEnrichmentAdaptiveQuad.'''
...
@rfm.simple_test
class RunOnlyTestPoissonProblemEnrichmentAdaptiveQuad(rfm.RunOnlyRegressionTest):
    target_name = 'TestPoissonProblemEnrichmentAdaptiveQuad'
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        RunOnlyTestPoissonProblemEnrichmentAdaptiveQuad.'''
        msgThrownException = '''Found exceptions in
        RunOnlyTestPoissonProblemEnrichmentAdaptiveQuad'''
        msgAssertFail = '''Found assert fail(s) in
        RunOnlyTestPoissonProblemEnrichmentAdaptiveQuad'''
