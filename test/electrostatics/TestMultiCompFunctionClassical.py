...
@rfm.simple_test
class BuildOnlyTestMultiCompFunctionClassical(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestMultiCompFunctionClassical'
    build_system = 'CMake'
    make_opts = ['TestMultiCompFunctionClassical']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestMultiCompFunctionClassical(rfm.RegressionTest):
    target_name = 'TestMultiCompFunctionClassical'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestMultiCompFunctionClassical.'''
...
@rfm.simple_test
class RunOnlyTestMultiCompFunctionClassical(rfm.RunOnlyRegressionTest):
    target_name = 'TestMultiCompFunctionClassical'
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        RunOnlyTestMultiCompFunctionClassical.'''
        msgThrownException = '''Found exceptions in
        RunOnlyTestMultiCompFunctionClassical'''
        msgAssertFail = '''Found assert fail(s) in
        RunOnlyTestMultiCompFunctionClassical'''
