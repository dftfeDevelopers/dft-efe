...
@rfm.simple_test
class BuildOnlyTestMPIPatternP2PTargeData(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestMPIPatternP2PTargetData'
    build_system = 'CMake'
    make_opts = ['TestMPIPatternP2PTargetData']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestMPIPatternP2PTargetData1Node4Procs(rfm.RegressionTest):
    target_name = 'TestMPIPatternP2PTargetData'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestMPIPatternP2PTargetData1Node4Procs.'''
...
@rfm.simple_test
class RunOnlyTestMPIPatternP2PTargetData1Node4Procs(rfm.RunOnlyRegressionTest):
    target_name = 'TestMPIPatternP2PTargetData'
    descr = '''A run only test to verify the ghost data in MPIPatternP2P on 1
    node with 4 processors'''
    build_system = 'CMake'
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        RunOnlyTestMPIPatternP2PTargetData1Node4Procs.'''
        msgThrownException = '''Found exceptions in
        RunOnlyTestMPIPatternP2PTargetData1Node4Procs'''
        msgAssertFail = '''Found assert fail(s) in
        RunOnlyTestMPIPatternP2PTargetData1Node4Procs'''
...
@rfm.simple_test
class BuildAndRunTestMPIPatternP2PTargetData2Node4Procs(rfm.RegressionTest):
    target_name = 'TestMPIPatternP2PTargetData'
    descr = '''A run only test to verify the ghost data in MPIPatternP2P on 1
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        BuildAndRunTestMPIPatternP2PTargetData2Node4Procs.'''
        msgThrownException = '''Found exceptions in 
        BuildAndRunTestMPIPatternP2PTargetData2Node4Procs.'''
        msgAssertFail = '''Found assert fail(s) in
        BuildAndRunTestMPIPatternP2PTargetData2Node4Procs.'''
...
@rfm.simple_test
class RunOnlyTestMPIPatternP2PTargetData2Node4Procs(rfm.RunOnlyRegressionTest):
    target_name = 'TestMPIPatternP2PTargetData'
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        RunOnlyTestMPIPatternP2PTargetData2Node4Procs.'''
        msgThrownException = '''Found exceptions in
        RunOnlyTestMPIPatternP2PTargetData2Node4Procs'''
        msgAssertFail = '''Found assert fail(s) in
        RunOnlyTestMPIPatternP2PTargetData2Node4Procs'''
