...
@rfm.simple_test
class TestCubicSplineAlglibConv(rfm.CompileOnlyRegressionTest):
    descr = '''Compile only test for cubic spline using alglib conv method'''
    build_system = 'CMake'
    make_opts = ['TestCubicSplineAlglibConv']
    sourcesdir = './src'
