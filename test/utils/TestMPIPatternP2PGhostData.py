...
@rfm.simple_test
class BuildOnlyTestMPIPatternP2PGhostData(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestMPIPatternP2PGhostData'
    build_system = 'CMake'
    make_opts = ['TestMPIPatternP2PGhostData']
    sourcesdir = './src'
