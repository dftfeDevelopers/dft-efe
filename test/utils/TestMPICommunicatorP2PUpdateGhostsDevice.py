...
@rfm.simple_test
class BuildOnlyTestMPICommunicatorP2PUpdateGhostsDevice(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestMPICommunicatorP2PUpdateGhostsDevice'
    build_system = 'CMake'
    make_opts = ['TestMPICommunicatorP2PUpdateGhostsDevice']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestMPICommunicatorP2PUpdateGhostsDevice1Node2Procs(rfm.RegressionTest):
    target_name = 'TestMPICommunicatorP2PUpdateGhostsDevice'
    descr = '''A build and run test to verify the ghost data in MPICommunicatorP2P on 1
    node with 2 processors and 2 GPUs'''
    build_system = 'CMake'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestMPICommunicatorP2PUpdateGhostsDevice1Node2Procs.'''
...
@rfm.simple_test
class RunOnlyTestMPICommunicatorP2PUpdateGhostsDevice1Node2Procs(rfm.RunOnlyRegressionTest):
    target_name = 'TestMPICommunicatorP2PUpdateGhostsDevice'
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        RunOnlyTestMPICommunicatorP2PUpdateGhostsDevice1Node2Procs.'''
        msgThrownException = '''Found exceptions in
        RunOnlyTestMPICommunicatorP2PUpdateGhostsDevice1Node2Procs'''
        msgAssertFail = '''Found assert fail(s) in
        RunOnlyTestMPICommunicatorP2PUpdateGhostsDevice1Node2Procs'''
