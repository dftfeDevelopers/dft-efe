...
@rfm.simple_test
class BuildOnlyTestMPICommunicatorP2PAccumulateAdd(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestMPICommunicatorP2PAccumulateAdd'
    build_system = 'CMake'
    make_opts = ['TestMPICommunicatorP2PAccumulateAdd']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestMPICommunicatorP2PAccumulateAdd1Node4Procs(rfm.RegressionTest):
    target_name = 'TestMPICommunicatorP2PAccumulateAdd'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestMPICommunicatorP2PAccumulateAdd1Node4Procs.'''
...
@rfm.simple_test
class RunOnlyTestMPICommunicatorP2PAccumulateAdd1Node4Procs(rfm.RunOnlyRegressionTest):
    target_name = 'TestMPICommunicatorP2PAccumulateAdd'
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        RunOnlyTestMPICommunicatorP2PAccumulateAdd1Node4Procs.'''
        msgThrownException = '''Found exceptions in
        RunOnlyTestMPICommunicatorP2PAccumulateAdd1Node4Procs'''
        msgAssertFail = '''Found assert fail(s) in
        RunOnlyTestMPICommunicatorP2PAccumulateAdd1Node4Procs'''
