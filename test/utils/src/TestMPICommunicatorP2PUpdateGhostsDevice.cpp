...
int main()
{
  ...
  std::shared_ptr<const dftefe::utils::MPIPatternP2P<dftefe::utils::MemorySpace::DEVICE>>
    mpiPatternP2PPtr= std::make_shared<dftefe::utils::MPIPatternP2P<dftefe::utils::MemorySpace::DEVICE>>(locallyOwnedRange,
	ghostIndices,
	MPI_COMM_WORLD);
  ...
  dftefe::utils::MPICommunicatorP2P<double,dftefe::utils::MemorySpace::DEVICE> mpiCommunicatorP2P1(mpiPatternP2PPtr,1);
  ...
  dftefe::utils::MPICommunicatorP2P<std::complex<double>,dftefe::utils::MemorySpace::DEVICE> mpiCommunicatorP2P2(mpiPatternP2PPtr,1);
  ...
  dftefe::utils::MPICommunicatorP2P<double,dftefe::utils::MemorySpace::DEVICE> mpiCommunicatorP2P3(mpiPatternP2PPtr,blockSize);
