...
@rfm.simple_test
class BuildOnlyTestKSDFTClassical(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestKSDFTClassical'
    build_system = 'CMake'
    make_opts = ['TestKSDFTClassical']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestKSDFTClassical(rfm.RegressionTest):
    target_name = 'TestKSDFTClassical'
...
@rfm.simple_test
class RunOnlyTestKSDFTClassical(rfm.RunOnlyRegressionTest):
    target_name = 'TestKSDFTClassical'
