...
@rfm.simple_test
class BuildOnlyTestHXOrthoEFE(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestHXOrthoEFE'
    build_system = 'CMake'
    make_opts = ['TestHXOrthoEFE']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestHXOrthoEFE(rfm.RegressionTest):
    target_name = 'TestHXOrthoEFE'
...
@rfm.simple_test
class RunOnlyTestHXOrthoEFE(rfm.RunOnlyRegressionTest):
    target_name = 'TestHXOrthoEFE'
