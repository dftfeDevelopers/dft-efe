...
@rfm.simple_test
class BuildOnlyTestKSDFTOrthoEFE(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestKSDFTOrthoEFE'
    build_system = 'CMake'
    make_opts = ['TestKSDFTOrthoEFE']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestKSDFTOrthoEFE(rfm.RegressionTest):
    target_name = 'TestKSDFTOrthoEFE'
...
@rfm.simple_test
class RunOnlyTestKSDFTOrthoEFE(rfm.RunOnlyRegressionTest):
    target_name = 'TestKSDFTOrthoEFE'
