...
@rfm.simple_test
class BuildOnlyTestKSAllElectronEigenSolveOrthoEFE(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestKSAllElectronEigenSolveOrthoEFE'
    build_system = 'CMake'
    make_opts = ['TestKSAllElectronEigenSolveOrthoEFE']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestKSAllElectronEigenSolveOrthoEFE(rfm.RegressionTest):
    target_name = 'TestKSAllElectronEigenSolveOrthoEFE'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestKSAllElectronEigenSolveOrthoEFE.'''
...
@rfm.simple_test
class RunOnlyTestKSAllElectronEigenSolveOrthoEFE(rfm.RunOnlyRegressionTest):
    target_name = 'TestKSAllElectronEigenSolveOrthoEFE'
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        RunOnlyTestKSAllElectronEigenSolveOrthoEFE.'''
        msgThrownException = '''Found exceptions in
        RunOnlyTestKSAllElectronEigenSolveOrthoEFE'''
        msgAssertFail = '''Found assert fail(s) in
        RunOnlyTestKSAllElectronEigenSolveOrthoEFE'''
