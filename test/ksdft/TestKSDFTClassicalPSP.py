...
@rfm.simple_test
class BuildOnlyTestKSDFTClassicalPSP(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestKSDFTClassicalPSP'
    build_system = 'CMake'
    make_opts = ['TestKSDFTClassicalPSP']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestKSDFTClassicalPSP(rfm.RegressionTest):
    target_name = 'TestKSDFTClassicalPSP'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestKSDFTClassicalPSP.'''
...
@rfm.simple_test
class RunOnlyTestKSDFTClassicalPSP(rfm.RunOnlyRegressionTest):
    target_name = 'TestKSDFTClassicalPSP'
