...
@rfm.simple_test
class BuildOnlyTestHamiltonianClassical(rfm.CompileOnlyRegressionTest):
    descr = 'Compile only test for TestHamiltonianClassical'
    build_system = 'CMake'
    make_opts = ['TestHamiltonianClassical']
    sourcesdir = './src'
...
@rfm.simple_test
class BuildAndRunTestHamiltonianClassical(rfm.RegressionTest):
    target_name = 'TestHamiltonianClassical'
    ...
    def validate_test(self):
        ...
        BuildAndRunTestHamiltonianClassical.'''
...
@rfm.simple_test
class RunOnlyTestHamiltonianClassical(rfm.RunOnlyRegressionTest):
    target_name = 'TestHamiltonianClassical'
    ...
    def validate_test(self):
        ...
        hasError = True
        msgError = '''Found error(s) in
        RunOnlyTestHamiltonianClassical.'''
        msgThrownException = '''Found exceptions in
        RunOnlyTestHamiltonianClassical'''
        msgAssertFail = '''Found assert fail(s) in
        RunOnlyTestHamiltonianClassical'''
