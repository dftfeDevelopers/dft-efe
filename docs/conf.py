...
def configureDoxyfile(output_dir):
	...
	filedata = filedata.replace('@PROJECT_VERSION@', 'development version')
...
project = 'DFT-EFE'
copyright = '2021, The DFT-EFE Developers'
author = 'yes'
...
# Remove dftefe:: prefix when creating the global index.
cpp_index_common_prefix = ['dftefe::']
