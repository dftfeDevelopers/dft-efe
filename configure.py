...
cmake_dict = {'ELPA_DIR':['', 'Path to ELPA installation',
              ...
              'DEALII_PATH':['','Path to the deal.ii installation',
               ...
               'DEAL_II_CXX_FLAGS_RELEASE':['','CXX flages release the deal.ii installation',
              ...
              'CMAKE_CXX_FLAGS_RELEASE':['','C++ compiler flags',
                                 '--CMAKE_CXX_FLAGS_RELEASE="-g -O2"'],                                
              ...
              'ENABLE_GPU':['OFF','ON or OFF based on whether to use GPU or not',
                             '--ENABLE_GPU=OFF/ON'],
              'GPU_LANG':['OFF','ON or OFF based on whether to use GPU or not',
                             '--GPU_LANG=cuda/hip/sycl'],
              'GPU_VENDOR':['OFF','ON or OFF based on whether to use GPU or not',
